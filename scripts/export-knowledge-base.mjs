...
const routes = [
  { path: '/', title: 'Home - Dayananda Sagar University' },
  { path: '/about', title: 'About DSU' },
  { path: '/academics', title: 'Academics' },
  { path: '/academics/engineering', title: 'School of Engineering' },
  { path: '/academics/law', title: 'School of Law' },
  { path: '/academics/health-sciences', title: 'School of Health Sciences' },
  { path: '/academics/computer-applications', title: 'School of Computer Applications' },
  { path: '/academics/basic-applied-sciences', title: 'School of Basic and Applied Sciences' },
  { path: '/academics/commerce-and-management', title: 'School of Commerce and Management' },
  { path: '/academics/humanities-social-sciences', title: 'School of Humanities and Social Sciences' },
  { path: '/academics/design/bdesign', title: 'School of Design and Digital Trans-media' },
  { path: '/academics/journalism-mass-communication', title: 'School of Journalism and Mass Communication' },
  { path: '/admissions', title: 'Admissions' },
  { path: '/eligibility', title: 'Eligibility' },
  { path: '/international-admissions', title: 'International Admissions' },
  { path: '/study-in-india', title: 'Study in India' },
  { path: '/campus-life', title: 'Campus Life' },
  { path: '/research', title: 'Research' },
  { path: '/library', title: 'Library' },
  { path: '/alumni', title: 'Alumni' },
  { path: '/placements', title: 'Placements' },
  { path: '/ai-first', title: 'AI-First University' },
  { path: '/nvidia-ai-architecture', title: 'NVIDIA AI Architecture' },
  { path: '/faculty-directory', title: 'Faculty Directory' },
  { path: '/vision-mission', title: 'Vision & Mission' },
  { path: '/leadership', title: 'Leadership' },
  { path: '/accreditations', title: 'Accreditations' },
