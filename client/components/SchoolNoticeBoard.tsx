...
import { getSchoolContent, getCategoryStyles, type CarouselItem } from "@/lib/content-manager";
import { Download } from "lucide-react";

export function SchoolNoticeBoard({ school }: { school: string }) {
  const { announcements, news: newsItems, events: eventItems } = getSchoolContent(school);
