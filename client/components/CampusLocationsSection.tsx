    ...
    <section className="px-3 py-10 md:py-16 relative bg-background">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="max-w-3xl mx-auto">
          <div className="rounded-2xl overflow-hidden border-2 border-brand-orange/20 bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-sm hover:border-brand-orange/40 transition-all duration-500 hover:shadow-2xl hover:shadow-brand-orange/20">
            {/* Map Container */}
