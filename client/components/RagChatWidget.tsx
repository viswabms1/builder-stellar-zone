      ...
      <AnimatePresence>
        {!isOpen && (
          <motion.button
            ...
            className={cn(
              "fixed bottom-16 sm:bottom-20 lg:bottom-6 xl:bottom-6 right-12 lg:right-6 z-[9997] rounded-full p-4 shadow-lg hover:shadow-xl transition-all hover:scale-110",
              theme === "light"
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className={cn(
              "fixed bottom-16 sm:bottom-20 lg:bottom-6 xl:bottom-6 right-12 lg:right-6 z-[9998] w-96 h-[600px] rounded-2xl shadow-2xl flex flex-col",
              theme === "light"
