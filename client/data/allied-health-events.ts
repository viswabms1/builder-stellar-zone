...
export const getAlliedHealthEvents = (): NoticeItem[] => [
  {
    ...
    description:
      "Joint seminar on modern healthcare practices in Allied Health Sciences.",
    date: "April 7, 2024",
    category: "Event",
    image:
      "https://images.unsplash.com/photo-1505751172107-104990666014?q=80&w=800&auto=format&fit=crop",
  },
  {
    id: "2",
...
export const getAlliedHealthNews = (): NoticeItem[] => [
  {
    ...
    description:
      "Faculty members of Allied Health Sciences received awards for their research in medical technology.",
    date: "March 20, 2024",
    category: "News",
    image:
...
export const getAlliedHealthAnnouncements = (): NoticeItem[] => [
  {
    ...
    description:
      "Applications are invited for various B.Sc and M.Sc Allied Health Sciences programs.",
    date: "Ongoing",
