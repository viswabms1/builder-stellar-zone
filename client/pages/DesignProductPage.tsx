...
/* ───────────────────── image assets ───────────────────── */
const HERO_IMAGES = [
  "/images/prod-hero-1.jpg",
  "/images/prod-hero-2.jpg",
  "/images/prod-hero-3.jpg",
  "/images/prod-hero-4.jpg",
  "/images/prod-hero-5.jpg",
  "/images/prod-hero-6.jpg",
];

const WHY_CHOOSE_IMG = "/images/prod-why-choose.jpg";
const WHAT_LEARN_IMG = "/images/prod-what-learn.jpg";
const CAREER_IMG = "/images/prod-career.jpg";

/* ───────────────────── data ───────────────────── */
const WHY_CARDS = [
  {
    icon: "/images/prod-icon-book.svg",
    title: "Comprehensive Curriculum",
    desc: "Strong foundation in design thinking, ergonomics, research, and prototyping.",
  },
  {
    icon: "/images/prod-icon-hand.svg",
    title: "Hands-On Projects",
    desc: "Real-world projects developing research, ideation, prototyping, and validation skills.",
  },
  {
    icon: "/images/prod-icon-toolbox.svg",
    title: "Industry-Standard Tools",
    desc: "Advanced modeling, visualization, simulation, and rapid prototyping capabilities.",
  },
  {
    icon: "/images/prod-icon-building.svg",
    title: "Industry Connections",
    desc: "Industry mentorship, guest lectures, live projects, and professional exposure.",
  },
];

const LEARN_ITEMS = [
  { title: "Visual Thinking & Concept Sketching", desc: "Sketch and visualize your ideas with confidence." },
  { title: "Prototyping & Model Making", desc: "Build physical prototypes to test, refine, and perfect your concepts." },
  { title: "Ergonomic & Functional Design", desc: "Design intuitive, ergonomic, and functional products." },
  { title: "Design Storytelling & Communication", desc: "Craft impactful stories around your designs that captivate users." },
  { title: "Real-World Product Development", desc: "Work on real-world projects and take them from concept to reality." },
];

const CAREER_TAGS_ROW1 = [
  "Product Designer", "Industrial Designer", "Design Researcher", "Industrial Designer", "Clay Modeler",
];
const CAREER_TAGS_ROW2 = [
  "CAD Modeler", "Product Design Consultant", "Product Design Lead", "Digital Sculptor",
];
...
const SEMESTER_DATA: { left: string; right: string; leftSubjects?: string[]; rightSubjects?: string[] }[] = [
  ...
  },
  {
    ...
    leftSubjects: ["Ergonomics", "Engineering Basics", "Representation Techniques", "Basics of CAD and 3D Printing", "Physical Prototyping", "Design Studio - I Mini Project - III"],
    rightSubjects: ["Material Exploration - I", "Product Research", "Product Form Studies", "Computer Aided Design", "Colour Material Trim", "Design Studio - II Mini Project - IV"],
  },
  {
    left: "SEMESTER - 5", right: "SEMESTER - 6",
    leftSubjects: ["Material Exploration - II", "Ideation Methodology in Design", "3D Surface Visualization", "Mini Project - V Interdisciplinary Design Project", "Professional Elective - I", "Professional Elective - II"],
    rightSubjects: ["Advanced Ergonomics", "Rendering Techniques", "Open Elective - I", "Professional Elective - III", "Professional Elective - IV", "Mini Project - VI Design for Sustainability"],
  },
  {
    left: "SEMESTER - 7", right: "SEMESTER - 8",
    leftSubjects: ["Major Project Stage - I", "Internship", "Designing for Human Behaviour", "Design & Entrepreneurship", "Portfolio and Design"],
    rightSubjects: ["Major Project Stage - II"],
  },
  {
    left: "Professional Elective - I", right: "Professional Elective - II",
    leftSubjects: ["Design of Smart Systems", "Vehicle Styling", "Design Semiotics and Semantics", "Human Computer Interaction"],
    rightSubjects: ["Design Management", "Interior Design", "Packaging and Branding Design", "Design Simulation and Analysis", "New Product Development"],
  },
  {
    left: "Professional Elective - III", right: "Professional Elective - IV",
    leftSubjects: ["Application Design", "Technically Complex Products", "Introduction to Game Design", "Programming in Python and React JS"],
    rightSubjects: ["Product Life Cycle and Management", "AI Application in Design", "AR & VR Technologies in UX", "Design for Assembly and Disassembly", "Advanced Sculpting"],
  },
];
...
const ACCORDION_DATA = [
  {
    ...
    thumb: "/images/prod-peo-thumb.jpg",
    content: [
      "PEO1. Design, develop, test/verify and validate, and conduct operations of products.",
  ...
  },
  {
    ...
    thumb: "/images/prod-po-thumb.jpg",
    content: [
      "PO1. Design knowledge: Apply the knowledge of mathematics, science, engineering fundamentals, technology, arts and humanities to the solution of complex design problems.",
      ...
      "PO4. Conduct investigations of complex problems: Apply research-based knowledge and research methods including design of experiments, analysis and interpretation of data, and synthesis of the information to provide valid conclusions.",
      "PO5. Modern tool usage: Create, select, and apply appropriate techniques, resources, and modern design, engineering and IT tools including prediction and modeling to complex design activities with an understanding of the limitations.",
  ...
  },
  {
    ...
    thumb: "/images/prod-pso-thumb.jpg",
    content: [
      "PSO1. Design solutions that are functional, aesthetic, sustainable and usable in the physical and digital spaces, through the integration of design thinking, technology, science and arts.",
      "PSO2. Identify problems and opportunities to address the implicit and explicit user requirements for various user groups in particular, for old age, especially abled, and kids.",
      "PSO3. Analyse the impact of the design solutions on environment and be able to devise more sustainable solutions.",
      "PSO4. Design solutions, that confirm to public health, safety and the societal considerations, considering the appropriate cultural and emotional context of the users.",
    ],
  },
];
  ...
  return (
    <section className="relative w-full overflow-hidden bg-white" style={{ minHeight: "clamp(400px, 65.5vw, 1258px)" }}>
      ...
      >
        ...
        >
          Design Innovative, Human-Centered Products
        </h1>
        <p style={{ ...body28, maxWidth: "clamp(280px, 41.88vw, 804px)", marginBottom: "clamp(24px, 2.97vw, 57px)" }}>
          Learn how to ideate, prototype, and develop functional products that solve real-world problems through thoughtful design and innovation.
        </p>
      ...
      <div className="md:hidden w-full" style={{ padding: "clamp(16px,4vw,32px)" }}>
        <img src={HERO_IMAGES[0]} alt="Product Design" className="w-full object-cover" style={{ borderRadius: "14px", maxHeight: "300px" }} loading="lazy" />
      </div>
    </section>
  );
}
      ...
      >
        ...
        <div className="flex flex-col lg:flex-row" style={{ gap: "clamp(32px, 4.84vw, 93px)", flex: "1 1 auto" }}>
          <div style={{ maxWidth: "415px" }}>
            ...
            <p style={body28}>Bachelor of Design – Product Design</p>
          </div>
          <p style={{ ...body28, maxWidth: "703px" }}>
            The Product Design program builds core skills in design thinking, problem-solving, and product development. Students learn to transform ideas into impactful solutions through hands-on projects, research, and prototyping.
            <br /><br />
            The curriculum emphasizes innovation, real-world workflows, and industry insights, preparing graduates for careers in product design and related creative industries.
          </p>
        </div>
        {/* CTA */}
  ...
  return (
    ...
    >
      <div style={{ maxWidth: "1720px", margin: "0 auto" }}>
        ...
        >
          <h2 style={{ ...heading64, maxWidth: "846px" }}>Why To Choose Product Design?</h2>
          <p style={{ ...body28, maxWidth: "762px" }}>
            The Product Design program shapes ideas into meaningful, functional products that improve everyday life.
          </p>
        </div>
      ...
      >
        ...
        <div style={{ flex: "0 0 auto", width: "clamp(280px, 44.27vw, 850px)" }}>
          ...
          <p style={{ ...body28, maxWidth: "840px", marginBottom: "clamp(24px, 3.59vw, 69px)" }}>
            The Product Design program will give you the ability to research, conceptualize, rapidly prototype, validate through simulation, and realize products using advanced 3D printing and contemporary design methodologies.
          </p>
          <div className="hidden lg:block" style={{ borderRadius: "16px", overflow: "hidden", aspectRatio: "850/779" }}>
            <img
              src={WHAT_LEARN_IMG}
              alt="Students learning Product Design"
              className="w-full h-full object-cover"
              loading="lazy"
            />
          </div>
        ...
        <div className="lg:hidden w-full" style={{ borderRadius: "16px", overflow: "hidden", marginTop: "clamp(16px, 2vw, 32px)" }}>
          <img src={WHAT_LEARN_IMG} alt="Students learning Product Design" className="w-full object-cover" style={{ maxHeight: "400px" }} loading="lazy" />
        </div>
      </div>
    </section>
  );
    ...
    <section className="w-full" style={{ backgroundColor: "#000", padding: "clamp(32px, 5.21vw, 100px) 0 0 0" }}>
      <div style={{ padding: "0 clamp(20px, 5.21vw, 100px)", maxWidth: "1920px", margin: "0 auto" }}>
        ...
        >
          ...
          >
            Graduating with our Product design program can help you prepare for a wide range of roles, some of them include:
          </p>
        </div>

        {/* Large image */}
        <div style={{ borderRadius: "16px", overflow: "hidden", aspectRatio: "1720/779", maxWidth: "1720px", marginBottom: "clamp(40px, 5.7vw, 110px)" }}>
          <img src={CAREER_IMG} alt="Product Design studio" className="w-full h-full object-cover" loading="lazy" />
        </div>
      </div>
  ...
  return (
    ...
    >
      <div style={{ maxWidth: "1686px", margin: "0 auto" }}>
        ...
        <p style={{ ...body28, maxWidth: "1398px", marginBottom: "clamp(32px, 4.17vw, 80px)" }}>
