...
export default function Engineering() {
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="px-3 py-16 bg-gradient-to-br from-brand-orange/5 via-brand-magenta/5 to-brand-blue/5 border-y border-border/30">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
            {[
              ...
              >
                ...
                />
                <span className="hidden text-center font-semibold text-xs text-foreground px-2">
                  {recruiter.name}
                </span>
              </div>
            ))}
