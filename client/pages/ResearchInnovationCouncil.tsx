              ...
              <table className="w-full">
                ...
                <tbody>
                  ...
                  <tr className="border-b border-border/30 hover:bg-orange-500/5 transition-colors">
                    ...
                    <td className="px-6 py-4 text-sm font-medium text-foreground">Dr Y N Srikant</td>
                    <td className="px-6 py-4 text-sm text-foreground">Dean, Engineering, IISC, Bengaluru</td>
                    <td className="px-6 py-4 text-sm text-foreground">Member</td>
                  </tr>
                  <tr className="border-b border-border/30 hover:bg-orange-500/5 transition-colors">
                    <td className="px-6 py-4 text-sm text-foreground">5</td>
                    <td className="px-6 py-4 text-sm font-medium text-foreground">Dr Pradeep V Desai</td>
                    <td className="px-6 py-4 text-sm text-foreground">CEO, Entrepreneurship Centre IISC Campus, Bengaluru</td>
                    <td className="px-6 py-4 text-sm text-foreground">Member</td>
                  </tr>
                  <tr className="border-b border-border/30 hover:bg-orange-500/5 transition-colors">
                    <td className="px-6 py-4 text-sm text-foreground">6</td>
                    <td className="px-6 py-4 text-sm font-medium text-foreground">Dr Lokesh Boregowda</td>
                    <td className="px-6 py-4 text-sm text-foreground">Director, Samsung R&D Institute, Bengaluru</td>
                    <td className="px-6 py-4 text-sm text-foreground">Member</td>
                  </tr>
                  <tr className="border-b border-border/30 hover:bg-orange-500/5 transition-colors">
                    <td className="px-6 py-4 text-sm text-foreground">7</td>
                    <td className="px-6 py-4 text-sm font-medium text-foreground">Dr V Ramasubramanian</td>
                    <td className="px-6 py-4 text-sm text-foreground">Professor, IIITB, Bengaluru</td>
                    <td className="px-6 py-4 text-sm text-foreground">Member</td>
                  </tr>
                  <tr className="border-b border-border/30 hover:bg-orange-500/5 transition-colors">
                    <td className="px-6 py-4 text-sm text-foreground">8</td>
                    <td className="px-6 py-4 text-sm font-medium text-foreground">Dr Kumar N Sivarajan</td>
                    <td className="px-6 py-4 text-sm text-foreground">CTO, Tejas Networks, Bengaluru</td>
                    <td className="px-6 py-4 text-sm text-foreground">Member</td>
                  </tr>
                  <tr className="border-b border-border/30 hover:bg-orange-500/5 transition-colors">
                    <td className="px-6 py-4 text-sm text-foreground">9</td>
                    <td className="px-6 py-4 text-sm font-medium text-foreground">Dr Paturu Kondaiah</td>
                    <td className="px-6 py-4 text-sm text-foreground">INSA Senior Scientist, Dept of Molecular Reproduction, IISc, Bengaluru</td>
                    <td className="px-6 py-4 text-sm text-foreground">Member</td>
                  </tr>
                  <tr className="border-b border-border/30 hover:bg-orange-500/5 transition-colors">
                    <td className="px-6 py-4 text-sm text-foreground">10</td>
                    <td className="px-6 py-4 text-sm font-medium text-foreground">Dr Mahesh Pavan Sathavalli</td>
                    <td className="px-6 py-4 text-sm text-foreground">Program Manager, Mphasis, Bengaluru</td>
                    <td className="px-6 py-4 text-sm text-foreground">Member</td>
                  </tr>
                  <tr className="border-b border-border/30 hover:bg-orange-500/5 transition-colors">
                    ...
                    <td className="px-6 py-4 text-sm text-foreground">Professor of Commerce, Former I/C, Vice Chancellor, University of Mysore</td>
                    <td className="px-6 py-4 text-sm text-foreground">Member</td>
                  </tr>
                  <tr className="border-b border-border/30 hover:bg-orange-500/5 transition-colors">
                  ...
                  <tr className="border-b border-border/30 hover:bg-orange-500/5 transition-colors">
                    ...
                    <td className="px-6 py-4 text-sm text-foreground">Dean & Principal- CDSIMER, DSU</td>
                    <td className="px-6 py-4 text-sm text-foreground">Member</td>
                  </tr>
                  <tr className="border-b border-border/30 hover:bg-orange-500/5 transition-colors">
                  ...
                  <tr className="border-b border-border/30 hover:bg-orange-500/5 transition-colors">
                    ...
                    <td className="px-6 py-4 text-sm font-medium text-foreground">Capt. A. Nagaraj Subbarao</td>
                    <td className="px-6 py-4 text-sm text-foreground">Dean, School of Commerce and Management Studies, DSU</td>
                    <td className="px-6 py-4 text-sm text-foreground">Member</td>
                  </tr>
                  <tr className="border-b border-border/30 hover:bg-orange-500/5 transition-colors">
                  ...
                  <tr className="border-b border-border/30 hover:bg-orange-500/5 transition-colors">
                    ...
                    <td className="px-6 py-4 text-sm text-foreground">Dean, College of Journalism and Mass Communication</td>
                    <td className="px-6 py-4 text-sm text-foreground">Member</td>
                  </tr>
                  <tr className="border-b border-border/30 hover:bg-orange-500/5 transition-colors">
                  ...
                  <tr className="hover:bg-orange-500/5 transition-colors">
                    ...
                    <td className="px-6 py-4 text-sm text-foreground">Dean, Research & Development, DSU</td>
