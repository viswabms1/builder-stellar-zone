  ...
  const getSchoolsData = () => {
    const baseSchools = [
      ...
      },
      {
        ...
        image: 'https://cdn.builder.io/api/v1/image/assets%2F4aa279a8430d441dba9c55f659831878%2F4d9c5679b4e6494b8e19b9067f90a609?format=webp&width=800'
      },
      {
        key: 'health',
        icon: Stethoscope,
        ...
        image: 'https://cdn.builder.io/api/v1/image/assets%2F4aa279a8430d441dba9c55f659831878%2F96d75a92c8774e0bbeb3a2b3918d3137?format=webp&width=800'
      },
      {
        key: 'design',
        icon: Film,
