          ...
          <Card className="border-2 border-orange-500/20 bg-card/80 backdrop-blur-sm">
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <CardTitle className="text-2xl">Select Your Program</CardTitle>
                  <CardDescription>
                    Choose a program to view eligibility criteria and fee structure
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent>
              <Select onValueChange={handleProgramSelect}>
                <SelectTrigger className="w-full h-12 text-base">
                  <SelectValue placeholder="Search and select a program..." />
                </SelectTrigger>
                <SelectContent className="max-h-[400px]">
                  {schools.map((school) => (
                    <SelectGroup key={school.name}>
    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-orange-500/10 via-red-500/10 to-background py-16 lg:py-24">
      ...
      <div className="relative mx-auto max-w-6xl px-3 text-center">
        ...
        <p className="mt-6 text-lg text-foreground md:text-xl">
          Select any program to instantly view eligibility criteria, fee structure, and required documents.
        </p>
      </div>
    </section>
  );
