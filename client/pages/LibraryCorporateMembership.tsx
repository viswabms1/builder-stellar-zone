...
export default function LibraryCorporateMembership() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      {/* Hero Section */}
      <section className="relative py-16 lg:py-24 bg-gradient-to-br from-cyan-500/10 via-blue-600/5 to-background dark:from-cyan-500/20 dark:via-blue-600/15 overflow-hidden">
