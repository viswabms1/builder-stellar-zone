...
type FacultyEntry = (typeof cybersecurityFaculty)[number];
      ...
      <div className="text-center space-y-4 mb-16">
        <div>
          <h2 className="text-4xl md:text-5xl font-bold font-display text-foreground mb-3">
            Cybersecurity Faculty Directory
          </h2>
        ...
        <p className="max-w-2xl mx-auto text-lg md:text-xl text-foreground/75 leading-relaxed">
          Meet our expert faculty members—researchers, innovators, and mentors steering cybersecurity education and industry partnerships.
        </p>
      </div>
