...
export default function FacultyMechanical() {
  const leadership = useMemo(
    () => {
      ...
      return mechFaculty.sort((a, b) => rank(a.title) - rank(b.title));
    },
    [],
  );
...
type FacultyEntry = (typeof mechFaculty)[number];
      ...
      <div className="text-center space-y-4 mb-16">
        <div>
          <h2 className="text-4xl md:text-5xl font-bold font-display text-foreground mb-3">
            Mechanical Engineering Faculty Directory
          </h2>
          <div className="w-20 h-1.5 bg-gradient-to-r from-brand-orange to-brand-orange rounded-full mx-auto" />
        </div>
        <p className="max-w-2xl mx-auto text-lg md:text-xl text-foreground/75 leading-relaxed">
          Meet our exceptional faculty members—experts in design, thermal engineering, manufacturing, and mechanical innovation.
        </p>
      </div>
