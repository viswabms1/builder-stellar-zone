...
const QUICK_LINKS: QuickLink[] = [
  ...
  },
  {
    title: "Programs",
    description:
      "Map the spectrum of executive pathways and learning outcomes.",
    href: "#offerings",
    icon: GraduationCap,
  },
  {
  ...
  },
  {
    ...
    description:
      "Stay updated with executive education schedules and milestones.",
    href: "#resources",
    icon: CalendarDays,
  },
];
          ...
          <div className="mb-10 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <h2 className="mt-4 font-gilroy text-3xl">
                Navigate Executive Education
              </h2>
              <p className="mt-3 max-w-2xl text-sm text-muted-foreground font-graphik">
                Jump to programme architecture, speaker series, admissions
                resources and the executive experience at DSU.
              </p>
            </div>
            <a
