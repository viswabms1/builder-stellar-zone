...
export default function LibraryCollections() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      {/* Hero Section */}
      <section className="relative py-16 lg:py-24 bg-gradient-to-br from-amber-500/10 via-orange-600/5 to-background dark:from-amber-500/20 dark:via-orange-600/15 overflow-hidden">
