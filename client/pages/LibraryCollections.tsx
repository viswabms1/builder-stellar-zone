  ...
  const collections = [
    {
      ...
      count: "2,50,000+",
      description:
        "Comprehensive collection of textbooks, reference books, and research monographs across all disciplines",
    },
    {
      icon: Newspaper,
      ...
      count: "500+",
      description:
        "Leading national and international journals, magazines, and newspapers",
    },
    {
      icon: Disc3,
    ...
    },
    {
      ...
      count: "24/7",
      description:
        "E-books, online journals, databases, and research platforms",
    },
  ];
  ...
  const subjectAreas = [
    {
      ...
      items: "Electronics, Mechanical, Civil, Aerospace, Computer Science",
    },
    {
      name: "Computer Applications",
      items: "Software Development, Web Technology, Database Systems",
    },
    { name: "Sciences", items: "Physics, Chemistry, Mathematics, Biology" },
    {
      name: "Management Studies",
      items: "Finance, Marketing, Business Strategy, Economics",
    },
    { name: "Law", items: "Constitutional Law, Corporate Law, Criminal Law" },
    {
      name: "Health Sciences",
      items: "Nursing, Physiotherapy, Medical Science",
    },
    {
      name: "Arts & Humanities",
      items: "Literature, History, Philosophy, Social Sciences",
    },
  ];
      ...
      <section className="py-16 px-3 max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-foreground/70">
            A diverse and comprehensive collection serving all academic
            disciplines
          </p>
        </div>
        ...
        <Card className="border-none shadow-lg bg-amber-50 dark:bg-slate-800">
          ...
          >
            <p className="text-lg leading-relaxed text-foreground/80">
              The DSU Central Library follows a systematic and strategic
              approach to collection development. We focus on:
            </p>
            <ul className="list-disc list-inside space-y-2 text-foreground/70">
              <li>
                Acquiring quality resources that support curriculum and research
              </li>
              <li>Balancing print and digital formats based on user needs</li>
              <li>Regular weeding and updating of collections</li>
              <li>
                Investing in emerging subjects and interdisciplinary areas
              </li>
              <li>Maintaining currency of periodicals and online databases</li>
              <li>
                Building special collections aligned with university strengths
              </li>
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-foreground/70">
                  Search our entire collection through our digital library
              ...
              <div>
                ...
                <p className="text-foreground/70">
                  Browse and discover resources in person at our 560-capacity
                  library facility
                </p>
              </div>
              <div>
