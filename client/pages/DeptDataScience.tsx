    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative">
        ...
        <div className="absolute inset-0 flex items-center">
          <div className="max-w-7xl mx-auto px-3 pb-20 md:pb-0">
      ...
      <section className="px-3 py-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4">
            {/* Chairperson */}
            <div>
              <p className="text-xs font-semibold text-brand-orange uppercase tracking-wider mb-2">Professor and Chairperson</p>
              <Link to="/academics/engineering/data-science/faculty/dr-shaila-s-g">
                <div className="group relative overflow-hidden rounded-xl border border-border/40 bg-card/40 backdrop-blur-sm hover:shadow-lg hover:shadow-brand-orange/10 transition-all cursor-pointer">
                  <div className="relative">
                    ...
                    <img src="https://images.unsplash.com/photo-1507842072343-583f20270319?q=80&w=500&auto=format&fit=crop" alt="Dr. Shaila S. G" className="absolute inset-0 h-full w-full object-cover object-center group-hover:scale-[1.03] transition-transform duration-500" />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/30 to-transparent" />
                  </div>
                  <div className="absolute bottom-0 p-3 w-full">
                    <div className="text-white text-xs opacity-80">Professor</div>
                    <div className="text-white font-semibold text-sm font-display line-clamp-2">Dr. Shaila S. G</div>
                  </div>
                </div>
              </Link>
            </div>
...
function NoticeBoard() {
  const notices: NoticeItem[] = [
    {
      id: "notice-1",
      title: "B.Tech CSE (Data Science) Program Launch",
      category: "Event",
      date: "Jan 2025",
      description: "Welcome to the Data Science program with cutting-edge curriculum focusing on machine learning and data analytics.",
      image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=600&h=300&fit=crop",
      link: "https://www.dsu.edu.in/images/Engineering/DS-dept/notices/Program-Launch.pdf",
    },
    {
      id: "notice-2",
      title: "Guest Lectures by Data Science Industry Leaders",
      category: "Event",
      date: "Upcoming",
      description: "Weekly sessions featuring experts from leading data-driven organizations.",
      image: "https://images.unsplash.com/photo-1552664730-d307ca884978?w=600&h=300&fit=crop",
    },
    {
      id: "notice-3",
      title: "Data Science Internship Opportunities",
      category: "News",
      date: "Year-round",
      description: "Paid internships with top companies in finance, tech, healthcare, and e-commerce.",
      image: "https://images.unsplash.com/photo-1504384308090-c894fdcc538d?w=600&h=300&fit=crop",
      link: "https://www.dsu.edu.in/images/Engineering/DS-dept/notices/Internships.pdf",
    },
    {
      id: "notice-4",
      title: "Research in Machine Learning Accepted",
      category: "News",
      date: "Jan 2025",
      description: "Faculty research on advanced machine learning algorithms published in international journals.",
    ...
    },
    {
      ...
      date: "Mar 2025",
      description: "Students showcase their data science projects to industry recruiters and academic partners.",
    },
    {
      id: "notice-6",
      title: "New Electives in Advanced Analytics",
      category: "Announcement",
      date: "Feb 2025",
      description: "New courses in Big Data, Advanced ML, and Real-time Analytics now available for registration.",
      link: "https://www.dsu.edu.in/images/Engineering/DS-dept/notices/Curriculum-Updates.pdf",
    },
  ];
      ...
      return (
        <div className="space-y-4">
          <div className={`flex items-center gap-2 px-4 py-3 rounded-xl border-l-4 ${
            ...
            <h3 className={`headline-4 font-display ${color === "orange" ? "text-brand-orange" : "text-brand-orange"}`}>{title}</h3>
          </div>
      ...
      <div className="mx-auto max-w-7xl space-y-4">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="max-w-2xl text-sm text-foreground sm:text-base font-body">
              Stay updated with upcoming events, news, and important announcements from the Data Science department.
            </p>
          </div>
          <Badge className="w-fit rounded-full bg-brand-orange/15 px-4 py-2 text-xs font-semibold text-brand-orange border border-brand-orange/20">
            Updated weekly
