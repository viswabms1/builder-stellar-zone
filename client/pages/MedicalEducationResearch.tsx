...
const QUICK_LINKS: QuickLink[] = [
  {
    ...
    description: "Explore competency-based medical education, smart classrooms and clinical skills labs.",
    href: "#pillars",
    icon: GraduationCap
  },
  {
  ...
  },
  {
    ...
    description: "View DSU's clinical research initiatives and translational discovery programmes.",
  ...
  {
    title: "Admissions",
    description: "Connect with counsellors for MBBS, allied health and residency pathways.",
  ...
  },
  {
    ...
    description: "Stay updated on clinical conferences, community service and simulation workshops.",
    href: "#resources",
    icon: CalendarDays
  }
];
...
const HIGHLIGHTS: Highlight[] = [
  {
    ...
    description: "Digitally integrated campus co-locating medical college, hospital and research to nurture innovation.",
  ...
  },
  {
    ...
    description: "Comprehensive hospital serving 200+ villages with advanced diagnostics and emergency care.",
  ...
  },
  {
    ...
    description: "High-fidelity labs and central diagnostics align academics with real-world clinical decision making.",
    image: "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?q=80&w=1600&auto=format&fit=crop",
    icon: Stethoscope
  },
  {
    title: "Community Impact",
    description: "Preventive health drives, community medicine postings and public health research drive societal wellbeing.",
...
const PILLARS: Pillar[] = [
  {
    title: "Medical College",
    description: "Competency-based MBBS curriculum, interdisciplinary faculty and outcome-driven mentorship.",
    icon: GraduationCap,
  ...
  {
    title: "Research & Innovation",
    description: "Clinical research institute translating curiosity into solutions for emerging healthcare challenges.",
    icon: Microscope,
    href: "https://cdsimer.edu.in/research/cri"
  },
  {
    title: "Central Laboratory",
    description: "Integrated biochemistry, pathology and microbiology diagnostics supporting precision medicine.",
    icon: Stethoscope,
    href: "https://cdsimer.edu.in/central-laboratory"
  },
  {
    title: "Medical Education Unit",
    description: "Faculty development, assessment innovation and patient-centred pedagogy to elevate teaching excellence.",
    icon: Compass,
...
const RESOURCES: Resource[] = [
  {
    title: "Enquire Now",
    description: "Reach admissions advisors for programme details, eligibility and counselling support.",
    href: "https://cdsimer.edu.in/enquiry",
    badge: "Admissions"
  },
  {
    title: "Events & Community Service",
    description: "Track conferences, CMEs, community outreach and campus engagements at DSU medical campus.",
    href: "https://cdsimer.edu.in/events",
    badge: "Events"
  },
  {
    title: "Library & Learning Resources",
    description: "Access physical and digital repositories that support evidence-based medical education.",
    href: "https://cdsimer.edu.in/library",
    badge: "Library"
  },
  {
    title: "Video Tour",
    description: "Experience the campus virtually through a curated video tour of CDSIMER.",
    ...
    <div className="min-h-screen bg-background text-foreground">
      <section className="relative" id="top">
        <div className="h-[60vh] w-full overflow-hidden md:h-[70vh]">
          <img src={HERO_IMAGE} alt="Medical Education and Research" className="h-full w-full object-cover" />
        ...
        <div className="absolute inset-0 flex items-center">
          <div className="mx-auto max-w-7xl px-6">
            <div className="mb-6 inline-flex items-center rounded-full border border-brand-magenta/20 bg-brand-magenta/10 px-4 py-2">
              ...
              <span className="text-sm font-medium text-brand-magenta font-gilroy">Medical Education & Research</span>
            </div>
            <h1 className="mb-4 font-gilroy text-4xl leading-tight text-white md:text-6xl">Empowering Physicians Through Knowledge, Discovery & Healing</h1>
            <p className="max-w-3xl text-white/90 font-graphik text-lg">
              DSU's medical education and research ecosystem unites CDSIMER's smart campus, tertiary care hospital and translational research to elevate patient care and community wellbeing.
            </p>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <h2 className="mt-4 font-gilroy text-3xl">Navigate Medical Education & Research</h2>
              <p className="mt-3 max-w-2xl text-sm text-muted-foreground font-graphik">
                Access medical college pillars, admissions, research initiatives and campus life information in one place.
              </p>
            </div>
            <a
      ...
      <section id="highlights" className="bg-gradient-to-r from-brand-magenta/5 via-brand-orange/5 to-brand-blue/5 px-6 py-16">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            ...
            <h2 className="mt-5 font-gilroy text-3xl md:text-4xl">Smart Campus. Integrated Care. Translational Research.</h2>
          </div>
      ...
      <section id="pillars" className="px-6 py-16">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center">
            ...
            <h2 className="mt-4 font-gilroy text-3xl md:text-4xl">One Ecosystem. Many Possibilities.</h2>
            <p className="mt-3 text-sm text-muted-foreground font-graphik max-w-3xl mx-auto">
              From classroom to clinic, DSU Medical Education & Research unifies learning, care delivery and innovation for future-ready physicians.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            <div className="max-w-3xl">
              ...
              <h2 className="mt-4 font-gilroy text-3xl md:text-4xl">Plan Your Journey</h2>
              <p className="mt-3 text-sm text-muted-foreground font-graphik">
                Access enquiry support, campus events, library resources and immersive tours to experience DSU's medical ecosystem.
              </p>
            </div>
            <a
              href="https://cdsimer.edu.in/enquiry"
      ...
      <section className="px-6 pb-20">
        <div className="mx-auto max-w-4xl text-center">
          <div className="rounded-3xl border border-brand-magenta/20 bg-brand-magenta/5 p-10">
            <h3 className="mb-3 font-gilroy text-3xl">Shape the Future of Healthcare with DSU</h3>
            <p className="mb-6 text-muted-foreground font-graphik">
              Join a medical community that blends compassionate care, research innovation and community service on one vibrant campus.
            </p>
