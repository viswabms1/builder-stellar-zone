          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            {chairperson && (
              <div>
                ...
                <Link to={`/academics/engineering/artificial-intelligence/faculty/${chairperson.slug}`} className="group relative overflow-hidden rounded-xl border border-border/40 bg-card/40 backdrop-blur-sm hover:shadow-lg hover:shadow-brand-magenta/10 transition-all cursor-pointer block">
