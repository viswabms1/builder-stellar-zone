        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-3 gap-5 items-start">
          <div className="lg:col-span-2 space-y-3">
            ...
            <p className="text-foreground leading-relaxed font-body">
              The Department of Computer Science & Engineering (AI & ML) offers a dynamic ecosystem for study, research, and professional growth—powered by DSU's partnership with NVIDIA. The B.Tech AI & ML program combines core computing foundations with AI-focused coursework on enterprise-grade infrastructure including DGX B200 supercomputers, Jetson edge devices, and GPU-accelerated labs, enabling students to master CUDA, PyTorch, and TensorFlow on the same tools used by Google, Meta, and OpenAI. The M.Tech Artificial Intelligence program provides advanced research in generative models, reinforcement learning, and LLM systems, enabling students to conduct cutting-edge research and drive innovation. Together, these pathways prepare students for distinguished careers as AI researchers, ML engineers, and technology leaders in academia and industry.
            </p>
            <Card className="border border-border/50 bg-card/50 backdrop-blur-sm">
