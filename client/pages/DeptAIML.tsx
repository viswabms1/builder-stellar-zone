...
const faculty = [
  {
    ...
    image: "https://www.dsu.edu.in/images/Engineering/CSE-AIML/faculty/jayavrinda.jpg"
  },
  {
    name: "Dr. Vinutha N",
    title: "Associate Professor, CSE (AI & ML)",
    image: "https://www.dsu.edu.in/images/Engineering/CSE-AIML/faculty/vinutha.jpg"
  },
  {
    name: "Prof. Pradeep Kumar K",
    title: "Assistant Professor & BOS Coordinator, CSE (AI & ML)",
    image: "https://www.dsu.edu.in/images/Engineering/CSE-AIML/faculty/pradeep-kumar.jpg"
  }
];
    ...
    <section className="relative">
      ...
      <div className="absolute inset-0 flex items-center">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <h1 className="headline-1 text-white leading-tight font-gilroy">
            Design Intelligent Futures
          </h1>
          <p className="subheadline mt-3 max-w-2xl text-white/90 font-graphik">
      ...
      <div className="mx-auto grid max-w-6xl items-start gap-10 lg:grid-cols-3">
        <div className="lg:col-span-2 space-y-6">
          ...
          <p className="text-muted-foreground leading-relaxed font-graphik">
            The B.Tech in Computer Science & Engineering (AI & ML) combines core computing foundations with AI-focused coursework spanning natural language processing, robotics, reasoning, and intelligent decision-making. Students progress through a carefully sequenced curriculum covering basic sciences, mathematical and statistical foundations, machine learning, and artificial intelligence alongside liberal education components that shape holistic technologists.
          </p>
          <p className="text-muted-foreground leading-relaxed font-graphik">
            From the first year, learners engage with design thinking, communication, collaboration, and creativity while working on mentored projects, internships, and UG research opportunities. DSU&apos;s flexible structure supports majors, minors, and specialised tracks so every learner can personalise their journey and stay future-ready.
          </p>
        ...
        <div>
          <Card className="overflow-hidden border border-border/50 bg-card/50">
            ...
            <CardContent className="grid gap-2 text-sm font-graphik">
              <FactRow label="Programme Duration" value="4 Years / 8 Semesters" />
              <FactRow label="Industry Labs" value="IBM, NVIDIA, Automation & Robotics" />
              <FactRow label="Academic Flexibility" value="Majors, Minors & Honours" />
              <FactRow label="Experiential Learning" value="Mandatory internships & capstone" />
            </CardContent>
          </Card>
        </div>
      </div>
    ...
    <section className="bg-gradient-to-r from-brand-blue/5 via-brand-magenta/5 to-brand-orange/5 px-6 py-16">
      <div className="mx-auto max-w-7xl">
        <div className="mb-12 text-center">
          ...
          <p className="mt-3 text-sm text-muted-foreground font-graphik md:text-base">
            Graduates are poised to lead innovations across healthcare, finance, aviation, manufacturing, and smart mobility. Explore where your skills can make the greatest impact.
          </p>
        </div>
        <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
          {[
            {
              title: "USD 190.6B",
              description: "Projected global AI market size by 2025, accelerating demand for skilled engineers.",
              icon: LineChart
            },
            {
              title: "$58B",
              description: "Cumulative investments in machine learning driving digital transformation initiatives worldwide.",
              icon: Award
            },
            {
              title: "$23B",
              description: "Forecasted neural networks market by 2024 highlighting opportunities in deep learning.",
              icon: Brain
            },
            {
              title: "AI Across Verticals",
              description: "From precision healthcare to intelligent logistics, AI-powered solutions redefine possibilities.",
              icon: Sparkles
            }
          ].map((stat) => (
            <Card
            ...
            >
              <CardHeader className="space-y-3">
                ...
                <CardTitle className="text-xl font-semibold font-gilroy">
                  {stat.title}
                </CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="font-graphik text-sm leading-relaxed">
                  {stat.description}
                </CardDescription>
              </CardContent>
            </Card>
    ...
    <section className="px-6 py-16">
      <div className="mx-auto max-w-7xl">
        <div className="mb-10 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          <div>
            <h2 className="headline-3 font-gilroy">Innovation Labs & Studios</h2>
            <p className="mt-3 max-w-2xl text-sm text-muted-foreground font-graphik">
              Access DSU&apos;s industry-partnered labs and interdisciplinary studios that accelerate experimentation, prototyping, and research in artificial intelligence and autonomous systems.
            </p>
          </div>
          <a
          ...
          {labsAndStudios.map((lab) => (
            ...
            >
              ...
              <div className="absolute inset-x-0 bottom-0 p-5 text-white">
                <h3 className="text-lg font-semibold font-gilroy">{lab.title}</h3>
    ...
    <section className="bg-gradient-to-r from-brand-magenta/5 via-brand-orange/5 to-brand-blue/5 px-6 py-16">
      <div className="mx-auto max-w-7xl">
        <div className="mb-12 text-center">
          ...
          <p className="mt-3 text-sm text-muted-foreground font-graphik md:text-base">
            A balanced matrix covering liberal learning, foundational sciences, engineering sciences, and advanced AI stacks ensures graduates can analyse, optimise, and innovate responsibly.
          </p>
        </div>
        <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
          {courseMatrix.map((category) => (
            <Card key={category.category} className="h-full rounded-3xl border border-border/40 bg-card/50 backdrop-blur-sm">
              <CardHeader>
                <CardTitle className="text-lg font-gilroy">{category.category}</CardTitle>
              </CardHeader>
              <CardContent>
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-3">
          {valueAdditions.map((item) => (
            <Card key={item.title} className="rounded-3xl border border-brand-magenta/30 bg-card/60 backdrop-blur-sm">
              <CardHeader>
                <CardTitle className="text-lg font-gilroy">{item.title}</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-sm leading-relaxed font-graphik">
                  {item.description}
                </CardDescription>
              </CardContent>
            </Card>
  ...
  return (
    <section className="px-6 py-16">
      <div className="mx-auto max-w-7xl grid gap-10 lg:grid-cols-2">
        <div>
          <h2 className="headline-3 font-gilroy">Career Pathways</h2>
          <p className="mt-3 text-sm text-muted-foreground font-graphik">
            Harness DSU&apos;s partnerships, internships, and research collaborations to launch careers that span intelligent products, data-driven enterprises, and research-intensive organisations.
          </p>
          <Card className="mt-6 border border-border/50 bg-card/50">
            <CardContent className="grid gap-3 p-6">
              {careerPaths.map((role) => (
                <div key={role} className="flex items-start gap-2 text-sm text-muted-foreground font-graphik">
        ...
        <div>
          <h2 className="headline-3 font-gilroy">Internships & Projects</h2>
          <Card className="mt-4 border border-border/50 bg-card/50">
            <CardContent className="space-y-4 p-6 text-sm text-muted-foreground font-graphik">
              <p>
                Structured summer internships with top technology firms, research institutes, and innovation labs expose students to real-world AI deployments and interdisciplinary collaboration.
              </p>
              <p>
                Mini-projects are embedded across semesters to strengthen applied understanding. Final-year majors tackle societal challenges, frontier research, or entrepreneurial prototypes mentored by faculty and industry experts.
              </p>
              <p>
                Hackathons, Kaggle-style challenges, and live consultancy briefs ensure continuous practice with state-of-the-art tools and datasets.
              </p>
            </CardContent>
          </Card>
        </div>
  ...
  return (
    <section className="bg-gradient-to-r from-brand-blue/5 to-brand-magenta/5 px-6 py-16">
      <div className="mx-auto max-w-7xl">
        <div className="mb-10 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          <div>
            <h2 className="headline-3 font-gilroy">Faculty Leadership</h2>
            <p className="mt-3 max-w-2xl text-sm text-muted-foreground font-graphik">
              A multidisciplinary team with deep research expertise guides learners across machine learning theory, intelligent systems engineering, and responsible AI design.
            </p>
          </div>
          <a
          ...
          {faculty.map((member) => (
            ...
            >
              ...
              <div className="absolute bottom-0 p-4">
                <div className="text-white text-sm opacity-80 font-graphik">
                  {member.title}
                </div>
                <div className="text-white text-lg font-semibold font-gilroy">
                  {member.name}
                </div>
              </div>
            </Card>
      ...
      <div className="mx-auto max-w-5xl">
        <Card className="border border-brand-magenta/30 bg-card/60 backdrop-blur-sm">
          <CardContent className="grid gap-6 p-8 md:grid-cols-2">
            <div>
              <h3 className="text-2xl font-gilroy">Connect with the Department</h3>
              <p className="mt-3 text-sm text-muted-foreground font-graphik">
                Reach out for programme counselling, collaborative research, or industry partnership enquiries.
              </p>
            </div>
            <div className="space-y-3 text-sm font-graphik">
      ...
      <div className="mx-auto max-w-4xl">
        <Card className="rounded-3xl border border-brand-magenta/30 bg-brand-magenta/5">
          <CardContent className="p-10 text-center">
            <h3 className="headline-3 mb-4 font-gilroy">
              Join DSU&apos;s AI & ML Community
            </h3>
            <p className="mx-auto mb-6 max-w-2xl text-muted-foreground font-graphik">
              Co-create responsible intelligent systems with peers, researchers, and industry mentors while advancing the future of artificial intelligence.
            </p>
