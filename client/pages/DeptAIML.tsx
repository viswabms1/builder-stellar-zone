    ...
    <section className="bg-gradient-to-r from-brand-blue/5 via-brand-magenta/5 to-brand-orange/5 px-6 py-16">
      <div className="mx-auto max-w-7xl">
        <div className="mb-12 text-center">
          ...
          <p className="mt-3 text-sm text-white font-body md:text-base">
      ...
      <div className="mx-auto max-w-7xl grid gap-10 lg:grid-cols-2">
          ...
          <Card className="mt-6 border border-border/50 bg-card/50">
            <CardContent className="grid gap-3 p-6">
              {careerPaths.map((role) => (
                <div
                  key={role}
                  className="flex items-start gap-2 text-sm text-white font-body"
                >
        ...
        <div>
          ...
          <Card className="mt-4 border border-border/50 bg-card/50">
            <CardContent className="space-y-4 p-6 text-sm text-white font-body">
              <p>
          ...
          {faculty.map((member) => (
            ...
            >
              ...
              <div className="absolute bottom-0 p-4">
                <div className="text-white text-sm opacity-80 font-body">
                  {member.title}
                </div>
                <div className="text-white text-lg font-semibold font-display">
                  {member.name}
                </div>
              </div>
            </Card>
      ...
      <div className="mx-auto max-w-4xl">
        <Card className="rounded-3xl border border-brand-magenta/30 bg-brand-magenta/5">
          <CardContent className="p-10 text-center">
            ...
            <p className="mx-auto mb-6 max-w-2xl text-white font-body">
