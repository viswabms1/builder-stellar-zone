      ...
      <section className="px-6 pt-10">
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8 items-start">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-white mt-1 font-body">{f.title}{f.qualifications ? ` • ${f.qualifications}` : ''}</p>
            {f.email && (
              <div className="mt-5">
        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-3 gap-8 items-start">
          <div className="lg:col-span-2 space-y-6">
            <Card className="border border-border/50 bg-card/50">
              ...
              <CardContent className="space-y-3 text-sm text-white font-body">
                <p>
                  ...
                  {f.interests.map((kw, i) => (
                    <Card key={i} className="overflow-hidden border border-border/40 bg-card/40">
                      ...
                      <CardContent className="pt-3">
                        <div className="text-sm text-white font-body">{kw}</div>
                      </CardContent>
                    </Card>
                  ))}
                </div>
      ...
      <section className="px-6 pb-16">
        <div className="max-w-4xl mx-auto text-center">
          <div className="rounded-3xl p-8 border border-brand-magenta/20 bg-brand-magenta/5">
            ...
            <p className="text-white mb-4 font-body">Explore CSE programs and start your application today.</p>
            <Link to="/admissions">
