...
export default function Placements() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section
        ref={storiesRef}
        className="px-3 py-10 lg:py-16 bg-gradient-to-br from-brand-magenta/5 via-brand-blue/5 to-background dark:from-red-500/5 dark:via-orange-500/5"
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-bold font-display mb-6">
      ...
      <section className="px-3 py-10 lg:py-16 bg-gradient-to-br from-brand-blue/5 via-brand-magenta/5 to-background dark:from-orange-500/5 dark:via-red-600/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-bold font-display mb-6">
              <span className="bg-brand-gradient bg-clip-text text-transparent">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {placementServices.map((service, index) => {
              ...
              return (
                <Card
                  key={index}
                  className="bg-gradient-to-br from-card/80 via-card/60 to-card/40 backdrop-blur-sm border border-border/50 hover:border-brand-blue/30 hover:shadow-lg hover:shadow-brand-blue/20 transition-all duration-300"
                >
                  <CardHeader>
                    <div className="w-12 h-12 rounded-2xl bg-brand-blue/20 flex items-center justify-center mb-4">
                      <Icon className="w-6 h-6 text-brand-blue" />
      ...
      <section className="px-3 py-10 bg-gradient-to-br from-brand-blue/5 via-brand-magenta/5 to-background dark:from-orange-500/5 dark:via-red-600/5">
        <div className="max-w-7xl mx-auto">
