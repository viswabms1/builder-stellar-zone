...
const HERO_IMAGE = "https://images.unsplash.com/photo-1520607162513-77705c0f0d4a?q=80&w=2000&auto=format&fit=crop";
...
const QUICK_LINKS: QuickLink[] = [
  ...
  {
    title: "Dean's Office",
    description: "Connect with the School leadership for guidance and mentoring.",
  ...
  {
    title: "Apply to SCMS",
    description: "Begin your application journey into business leadership programmes.",
...
const USP_HIGHLIGHTS: Highlight[] = [
  {
    ...
    description: "Five decades of management education shaped by global-quality infrastructure, corporate mentors and entrepreneurial culture.",
  ...
  },
  {
    ...
    description: "Tap into DSU Labs, incubation centres and industry associations to prototype ideas and scale ventures.",
...
const PROGRAMMES: Programme[] = [
  {
    ...
    level: "Undergraduate",
    focus: "Build strong accounting, finance and analytics fundamentals with industry certifications.",
    link: "https://www.dsu.edu.in/commerce-management/bachelor-of-commerce-management"
  },
  {
    name: "Bachelor of Business Administration",
    level: "Undergraduate",
    focus: "Develop leadership and entrepreneurial skills through labs, internships and mentoring.",
    link: "https://www.dsu.edu.in/commerce-management/bba"
  },
  {
    name: "Master of Business Administration",
    level: "Postgraduate",
    focus: "Specialise in marketing, finance, HR, analytics and operations with global immersion.",
    link: "https://www.dsu.edu.in/commerce-management/mba"
  },
  {
    name: "Doctoral Programmes",
    level: "Doctoral",
    focus: "Research-driven doctoral tracks across commerce, management and entrepreneurship.",
...
const ADVANTAGES: Advantage[] = [
  {
    ...
    description: "Access DSU's IBM, NVIDIA, Automation and Design Innovation labs for business analytics and product incubation.",
    icon: Layers
  },
  {
    title: "Corporate Mentorship",
    description: "Industry partnerships deliver mentorship circles, live consulting briefs and leadership dialogues each term.",
    icon: Users
  },
  {
    title: "Global Immersion",
    description: "International study tours, guest lectures and exchange programmes broaden global business perspectives.",
    icon: Building
  },
  {
    title: "Career Lift Platform",
    description: "Dedicated placement coaching, alumni networking and start-up accelerators fuel career trajectories.",
    icon: DollarSign
  }
];
...
const RESOURCES: Resource[] = [
  {
    ...
    description: "Plan your semesters with the official DSU academic calendar including internships and assessments.",
    href: "https://www.dsu.edu.in/images/University/DSU_AC.pdf",
    badge: "Calendar"
  },
  {
    title: "NSS & NCC Activities",
    description: "Engage in community leadership programmes that build civic responsibility and social impact.",
    href: "https://www.dsu.edu.in/images/University/NSS_Actvities.pdf",
    badge: "Engage"
  },
  {
    title: "Sports Facilities",
    description: "Explore the world-class sports infrastructure that sustains wellbeing during rigorous academic schedules.",
    href: "https://www.dsu.edu.in/images/University/Sports_Facilities.pdf",
    badge: "Campus"
  },
  {
    title: "Photo Gallery",
    description: "Relive flagship conclaves, pitch fests and leadership summits hosted by SCMS.",
  ...
  return (
    <Card className="h-full rounded-3xl border border-border/50 bg-card/50 backdrop-blur-sm">
      <CardHeader className="flex flex-row items-center gap-3 pb-2">
        ...
        <CardTitle className="text-base font-gilroy">{advantage.title}</CardTitle>
      </CardHeader>
    ...
    <div className="min-h-screen bg-background text-foreground">
      <section className="relative" id="top">
        <div className="h-[60vh] w-full overflow-hidden md:h-[70vh]">
          <img src={HERO_IMAGE} alt="School of Commerce and Management Studies" className="h-full w-full object-cover" />
          ...
          <div className="mb-10 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-2xl text-sm text-muted-foreground font-graphik">
                Quick access to USP, programmes, innovation labs, leadership contacts and essential resources powering SCMS.
              </p>
            </div>
            <a
      ...
      <section id="usp" className="bg-gradient-to-r from-brand-magenta/5 via-brand-orange/5 to-brand-blue/5 px-6 py-16">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            ...
            <h2 className="mt-5 font-gilroy text-3xl md:text-4xl">Why Future Leaders Choose SCMS</h2>
          </div>
      ...
      <section id="programs" className="px-6 py-16">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center">
            ...
            <h2 className="mt-4 font-gilroy text-3xl md:text-4xl">Programmes that Build Business Trailblazers</h2>
            <p className="mt-3 text-sm text-muted-foreground font-graphik max-w-3xl mx-auto">
              Full-spectrum commerce and management programmes blend classroom mastery with analytics labs, consulting simulations and venture creation opportunities.
            </p>
          </div>
      ...
      <section id="advantages" className="bg-gradient-to-r from-brand-blue/5 to-brand-orange/5 px-6 py-16">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            <div className="max-w-3xl">
              <Badge className="bg-brand-magenta/15 text-brand-magenta">Career Advantages</Badge>
              <h2 className="mt-4 font-gilroy text-3xl md:text-4xl">Beyond the Classroom</h2>
              <p className="mt-3 text-sm text-muted-foreground font-graphik">
                Leverage innovation hubs, corporate mentorship, global immersions and placement readiness platforms that make DSU graduates highly sought after.
              </p>
            </div>
            <a
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            <div className="max-w-3xl">
              ...
              <h2 className="mt-4 font-gilroy text-3xl md:text-4xl">Stay Synced with SCMS</h2>
              <p className="mt-3 text-sm text-muted-foreground font-graphik">
                Download official documents, explore co-curricular platforms and plan your journey with key schedules, activities and galleries.
              </p>
            </div>
            <a
      ...
      <section className="px-6 pb-20">
        <div className="mx-auto max-w-4xl text-center">
          <div className="rounded-3xl border border-brand-magenta/20 bg-brand-magenta/5 p-10">
            <h3 className="mb-3 font-gilroy text-3xl">Drive Business Impact with DSU</h3>
            <p className="mb-6 text-muted-foreground font-graphik">
              Join a vibrant management community that transforms purpose-driven ideas into scalable ventures through mentorship, labs and global networks.
            </p>
            <div className="flex flex-col items-center justify-center gap-3 sm:flex-row">
              ...
              <a href="https://www.dsu.edu.in/commerce-management/mba" target="_blank" rel="noreferrer">
                <Button variant="outline" className="border-brand-magenta/40 hover:bg-brand-magenta/10">
                  MBA Brochure
                </Button>
              </a>
