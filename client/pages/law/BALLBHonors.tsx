  ...
  const programs = [
    {
      ...
      description:
        "5-year comprehensive undergraduate program with industry-aligned legal education",
      image:
        "https://images.unsplash.com/photo-1589578228447-91fce40ba2ad?q=80&w=1200&auto=format&fit=crop",
      batches: [
        {
          year: "2025-26",
          summary:
            "Latest curriculum with foundational legal theory, specialized subjects, and practical skills development across 10 semesters",
          documentUrl:
            "https://www.dsu.edu.in/images/Law/BA-LLB-Curriculum-2025-26.pdf",
        },
      ],
    },
  ];
...
export default function BALLBHonors() {
  ...
  const careers = [
    {
      title: "Litigator",
      description: "Represent clients in courts and legal proceedings",
    },
    {
      title: "Corporate Counsel",
      description: "Provide legal advice to corporations and businesses",
    },
    {
      title: "Legal Advisor",
      description: "Advise government agencies and organizations",
    },
    {
      title: "Judicial Officer",
      description: "Serve as magistrate or judge in legal system",
    },
  ];
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-lg text-foreground/75 mb-6 leading-relaxed">
                The BA.LLB (Honors) is a five-year integrated undergraduate
                program designed for students who wish to pursue a career in law
                directly after school. The program blends foundational legal
                theory with specialized subjects to foster critical thinking and
                practical skills essential for modern legal practice.
              </p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/75">
                      12+2 pass from recognized board
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mb-8">
            ...
            <p className="text-lg text-foreground/75 max-w-2xl">
              Access comprehensive curriculum documentation and syllabus for
              BA.LLB (Honors)
            </p>
          </div>
          <CurriculumLibrary />
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {specializations.map((spec, i) => {
              ...
              return (
                <Card
                  key={i}
                  className="border-border/30 bg-card/40 backdrop-blur-sm text-center"
                >
      ...
      <section className="px-3 py-16 bg-muted/40">
        <div className="mx-auto max-w-7xl text-center">
          ...
          <p className="text-lg text-foreground/75 mb-8 max-w-2xl mx-auto">
            Apply now to BA.LLB (Honors) and join a community of aspiring legal
            professionals.
          </p>
          <a
            href="https://admissions.dsu.edu.in/"
