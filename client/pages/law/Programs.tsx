...
const programs = [
  {
    ...
    title: "LLB (3-Year)",
    duration: "3 Years",
    description: "Designed for graduates from other fields pursuing a career in law.",
    fullDescription: "This program is designed for graduates from other fields who wish to pursue a career in law. It focuses on core legal subjects while allowing students to specialize in specific areas of law.",
    slug: "llb-3-year",
    icon: Target,
    highlights: [
  ...
  },
  {
    ...
    duration: "2 Years",
    description: "Postgraduate program exploring law and emerging technologies.",
    fullDescription: "A postgraduate program that explores the evolving intersection between law and emerging technologies. Students gain expertise in the regulation, challenges, and legal implications of technological advancements.",
  ...
  },
  {
    ...
    fullDescription: "This program delves into the complexities of corporate law, focusing on the regulatory environment, business transactions, mergers and acquisitions, intellectual property rights, and other aspects essential for a career in corporate law.",
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-brand-magenta/10 rounded-full border border-brand-magenta/20 mb-4">
              ...
              <span className="text-sm font-medium text-brand-magenta font-display">Academic Programs</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-bold font-display mb-4">
              Law Programs at DSU
            </h1>
            <p className="text-lg text-foreground/75 max-w-2xl mx-auto">
              Explore our comprehensive range of undergraduate and postgraduate law programs designed to prepare you for a successful career in law.
            </p>
          </div>
                  ...
                  <Card className="h-full hover:shadow-lg transition-all duration-300 border-border/50 hover:border-brand-magenta/30 bg-card/50 backdrop-blur-sm">
                    <CardHeader>
                      <div className="flex items-start justify-between mb-4">
                        ...
                        <Badge variant="outline" className="border-brand-magenta/30 text-brand-magenta">
                          {program.duration}
                        </Badge>
                      </div>
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <Button variant="ghost" className="w-full group-hover:bg-brand-magenta/10 group-hover:text-brand-magenta">
            ...
            {[
              {
                ...
                description: "Learn from experienced legal practitioners and scholars with industry expertise.",
              },
              {
                title: "Practical Learning",
                description: "Engage with moot courts, legal aid clinics, and real-world case studies.",
              },
              {
                title: "Career Support",
                description: "Mentorship from leading practitioners and strong placement support.",
              },
            ].map((feature, i) => (
      ...
      <section className="relative px-3 py-16">
        <div className="mx-auto max-w-7xl text-center">
          ...
          <p className="text-lg text-foreground/75 mb-8 max-w-2xl mx-auto">
            Apply now to one of our comprehensive law programs and begin your journey towards a distinguished legal career.
          </p>
