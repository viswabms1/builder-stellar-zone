...
function ResourceCard({ resource }: { resource: ResourceLink }) {
  return (
    <Card className="h-full rounded-3xl border border-border/40 bg-card/60 backdrop-blur">
      ...
      <CardContent className="space-y-5 text-sm text-slate-700 dark:text-slate-200 font-body">
...
function AchievementCard({ achievement }: { achievement: Achievement }) {
  ...
  return (
    <Card className="h-full rounded-3xl border border-border/40 bg-card/60 backdrop-blur">
      ...
      <CardContent>
        <p className="text-sm text-slate-700 dark:text-slate-200 font-body">
            ...
            <Card className="rounded-3xl border border-border/40 bg-gradient-to-br from-brand-blue/10 to-brand-magenta/10 backdrop-blur p-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-700 dark:text-slate-200 font-body">
      ...
      <section id="dean-message" className="px-6 py-16 bg-gradient-to-r from-brand-magenta/5 via-brand-orange/5 to-brand-blue/5">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="rounded-3xl border border-border/40 bg-card/60 backdrop-blur p-10">
            ...
            <div className="space-y-4 text-slate-700 dark:text-slate-200 font-body">
              <p>
      ...
      <section id="featured-faculty" className="px-6 py-16">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12">
            ...
            <p className="mt-3 text-slate-700 dark:text-slate-200 max-w-3xl font-body">
      ...
      <section id="life-at-dsu" className="px-6 py-16 bg-gradient-to-r from-brand-orange/5 via-brand-magenta/5 to-brand-blue/5">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            ...
            <p className="mt-3 text-slate-700 dark:text-slate-200 max-w-3xl font-body mx-auto">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                {PROGRAM_GROUPS.map((group) => (
                  ...
                  >
                    ...
                    <CardContent className="grid gap-2 text-sm text-slate-700 dark:text-slate-200 font-body">
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            <div className="max-w-3xl">
              ...
              <p className="mt-3 text-sm text-slate-700 dark:text-slate-200 font-body">
      ...
      <section className="px-6 pb-20">
        <div className="mx-auto max-w-4xl text-center">
          <div className="rounded-3xl border border-brand-magenta/20 bg-brand-magenta/5 p-10">
            ...
            <p className="mb-6 text-slate-700 dark:text-slate-200 font-body">
