  ...
  return (
    <Card className="h-full rounded-3xl border border-border/50 bg-card/50 backdrop-blur-sm">
      ...
      <CardContent className="pt-0">
        <CardDescription className="text-sm leading-relaxed text-slate-800 dark:text-slate-300 font-body">
          {lab.description}
        </CardDescription>
      </CardContent>
    </Card>
            ...
            <div className="grid gap-6 md:grid-cols-3">
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-800 dark:text-slate-300">Pursuing highest standards in education, research, and student outcomes</p>
                </div>
              </div>
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-800 dark:text-slate-300">Building strong partnerships with industry, academia, and communities</p>
                </div>
              </div>
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-800 dark:text-slate-300">Fostering creativity, experimentation, and disruptive thinking</p>
                </div>
              </div>
            </div>
          </div>
