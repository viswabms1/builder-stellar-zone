      ...
      <section className="py-16 px-3 max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {galleryImages.map((image, idx) => (
            <Card
              key={idx}
              className="border-none shadow-md hover:shadow-xl transition-all group overflow-hidden cursor-pointer"
            >
          ...
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              <p className="text-foreground/70 mb-4">
                Experience our world-class facilities in person. The DSU Central
                Library welcomes all students, faculty, and staff during
                operating hours.
              </p>
              <div className="space-y-2 text-sm text-foreground/70">
                <p>
                  <strong>Location:</strong> Main Campus, Devarakaggalahalli
                </p>
                <p>
                  <strong>Hours:</strong> Monday - Saturday, 8:00 AM - 6:00 PM
                </p>
                <p>
                  <strong>Seating Capacity:</strong> 560 students
                </p>
              </div>
            </div>
          </CardContent>
