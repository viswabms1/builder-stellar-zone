...
function FacultyGridCard({ faculty }: { faculty: FacultyEntry }) {
  return (
    <Link
      to={`/academics/engineering/electronics-communication/faculty/${faculty.slug}`}
    ...
    <section className="py-10 md:py-28">
      <div className="text-center space-y-4 mb-16">
        <div>
          ...
          <div className="w-20 h-1.5 bg-gradient-to-r from-brand-blue to-brand-orange rounded-full mx-auto" />
        </div>
        <p className="max-w-2xl mx-auto text-lg md:text-xl text-foreground/75 leading-relaxed">
          Meet our exceptional faculty members—experts in VLSI design, signal processing, communications, and electronics innovation.
        </p>
      </div>
