...
import type { Faculty } from "@/data/air-faculty";

interface AIRoboticsFacultyPageTemplateProps {
  faculty: Faculty;
}

export default function AIRoboticsFacultyPageTemplate({ faculty }: AIRoboticsFacultyPageTemplateProps) {
  const bg = "https://images.unsplash.com/photo-1581091216562-40c08a5a4183?q=80&w=1600&auto=format&fit=crop";
            ...
            <Card className="rounded-2xl border border-border/50 bg-card/95 backdrop-blur">
              <CardContent className="p-5 md:p-3 flex gap-3 md:gap-4 items-center">
                ...
                <div className="flex-1">
                  <div className="text-brand-magenta text-xs font-body">AI and Robotics</div>
          ...
          <div className="lg:col-span-2 space-y-4">
            <Card className="border border-border/50 bg-card/50">
              ...
              <CardContent className="space-y-4">
                <p className="text-base leading-relaxed text-foreground font-body">
                  {faculty.name} is a dedicated faculty member in the AI and Robotics department at Dayananda Sagar University. With expertise in artificial intelligence, machine learning, computer vision, and robotics, {faculty.name.split(' ')[0]} contributes significantly to academic excellence and research endeavors.
                </p>
                <p className="text-base leading-relaxed text-foreground font-body">
                  Committed to advancing AI and Robotics education and fostering innovation, {faculty.name.split(' ')[0]} engages in curriculum development, student mentorship, and collaborative projects with academic institutions and industry partners. The faculty brings a blend of theoretical knowledge and practical expertise to enrich the learning experience of students.
                </p>
            ...
            <Card className="border border-border/50 bg-card/50">
              ...
              <CardContent className="text-sm text-foreground font-body">
                <p>
                  Dedicated to advancing AI and Robotics education and research. Engaged in curriculum development, student mentorship, and collaborative projects focusing on cognitive technologies, natural language processing, deep learning, computer vision, robotics, motion planning, sensor integration, and human-robot interaction.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border border-border/50 bg-card/50">
              ...
              <CardContent className="space-y-3 text-sm font-body">
                <div>
                  ...
                  <div className="font-medium text-brand-magenta hover:underline"><a href={`mailto:${faculty.name.toLowerCase().replace(/\s+/g, '.')}@dsu.edu.in`}>{faculty.name.toLowerCase().replace(/\s+/g, '.')}@dsu.edu.in</a></div>
                </div>
                <div>
                  <span className="text-foreground/70">Department</span>
                  <div className="font-medium text-foreground">AI and Robotics</div>
                </div>
              </CardContent>
            </Card>
