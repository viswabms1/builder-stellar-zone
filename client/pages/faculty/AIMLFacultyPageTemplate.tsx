...
import type { Faculty } from "@/data/aiml-faculty";

interface AIMLFacultyPageTemplateProps {
  faculty: Faculty;
}

export default function AIMLFacultyPageTemplate({ faculty }: AIMLFacultyPageTemplateProps) {
            ...
            <Card className="rounded-2xl border border-border/50 bg-card/95 backdrop-blur">
              <CardContent className="p-5 md:p-6 flex gap-6 md:gap-8 items-center">
                ...
                <div className="flex-1">
                  <div className="text-brand-magenta text-xs font-body">Computer Science & Engineering (AI & ML)</div>
          ...
          <div className="lg:col-span-2 space-y-8">
            <Card className="border border-border/50 bg-card/50">
              ...
              <CardContent className="space-y-4">
                <p className="text-base leading-relaxed text-foreground font-body">
                  {faculty.name} is a dedicated faculty member in the Computer Science & Engineering (AI & ML) department at Dayananda Sagar University. With expertise in artificial intelligence, machine learning, and emerging technologies, {faculty.name.split(' ')[0]} contributes significantly to academic excellence and research endeavors.
                </p>
                <p className="text-base leading-relaxed text-foreground font-body">
                  Committed to advancing AI and machine learning education and fostering innovation, {faculty.name.split(' ')[0]} engages in curriculum development, student mentorship, and collaborative projects with academic institutions and industry partners. The faculty brings a blend of theoretical knowledge and practical expertise to enrich the learning experience of students.
                </p>
            ...
            <Card className="border border-border/50 bg-card/50">
              ...
              <CardContent className="text-sm text-foreground font-body">
                <p>
                  Dedicated to advancing artificial intelligence and machine learning education and research. Engaged in curriculum development, student mentorship, and collaborative projects with industry and academic institutions focusing on AI innovation, responsible AI, and practical applications.
                </p>
              </CardContent>
            </Card>
          ...
          <div className="space-y-8">
            <Card className="border border-border/50 bg-card/50">
              ...
              <CardContent className="space-y-3 text-sm font-body">
                ...
                <div>
                  ...
                  <div className="font-medium">Computer Science & Engineering (AI & ML)</div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border border-border/50 bg-card/50">
              ...
              <CardContent className="space-y-2 text-sm font-body">
                ...
                <div className="text-foreground/70">Computer Science & Engineering (AI & ML)</div>
                <div className="text-foreground/70 text-xs">Dayananda Sagar University</div>
              </CardContent>
            </Card>

            <Link to="/academics/engineering/ai-ml/faculty" className="block">
