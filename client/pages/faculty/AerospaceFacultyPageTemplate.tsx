...
import type { Faculty } from "@/data/aerospace-faculty";

interface AerospaceFacultyPageTemplateProps {
  faculty: Faculty;
}

export default function AerospaceFacultyPageTemplate({ faculty }: AerospaceFacultyPageTemplateProps) {
  const bg = "https://images.unsplash.com/photo-1446776877081-d282a0f896e2?q=80&w=1600&auto=format&fit=crop";
            ...
            <Card className="rounded-2xl border border-border/50 bg-card/95 backdrop-blur">
              <CardContent className="p-5 md:p-6 flex gap-6 md:gap-8 items-center">
                ...
                <div className="flex-1">
                  <div className="text-brand-blue text-xs font-body">Aerospace Engineering</div>
          ...
          <div className="lg:col-span-2 space-y-8">
            <Card className="border border-border/50 bg-card/50">
              ...
              <CardContent className="space-y-4">
                <p className="text-base leading-relaxed text-foreground font-body">
                  {faculty.name} is a dedicated faculty member in the Aerospace Engineering department at Dayananda Sagar University. With expertise in aerodynamics, propulsion systems, flight control, and aerospace design, {faculty.name.split(' ')[0]} contributes significantly to academic excellence and research endeavors.
                </p>
                <p className="text-base leading-relaxed text-foreground font-body">
                  Committed to advancing aerospace engineering education and fostering innovation, {faculty.name.split(' ')[0]} engages in curriculum development, student mentorship, and collaborative projects with academic institutions and aerospace industry partners. The faculty brings a blend of theoretical knowledge and practical expertise to enrich the learning experience of students.
                </p>
            ...
            <Card className="border border-border/50 bg-card/50">
              ...
              <CardContent className="text-sm text-foreground font-body">
                <p>
                  Dedicated to advancing aerospace engineering education and research. Engaged in curriculum development, student mentorship, and collaborative projects with aerospace and defense organizations focusing on aerodynamics, propulsion systems, structural mechanics, flight control systems, and emerging aerospace technologies.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border border-border/50 bg-card/50">
              ...
              <CardContent className="space-y-3 text-sm font-body">
                ...
                <div>
                  ...
                  <div className="font-medium text-foreground">Aerospace Engineering</div>
                </div>
              </CardContent>
            </Card>
