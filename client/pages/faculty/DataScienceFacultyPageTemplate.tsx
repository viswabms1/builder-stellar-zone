...
import type { Faculty } from "@/data/data-science-faculty";

interface DataScienceFacultyPageTemplateProps {
  faculty: Faculty;
}

export default function DataScienceFacultyPageTemplate({ faculty }: DataScienceFacultyPageTemplateProps) {
            ...
            <Card className="rounded-2xl border border-border/50 bg-card/95 backdrop-blur">
              <CardContent className="p-5 md:p-6 flex gap-6 md:gap-8 items-center">
                ...
                <div className="flex-1">
                  <div className="text-brand-orange text-xs font-body">Data Science</div>
          ...
          <div className="lg:col-span-2 space-y-8">
            <Card className="border border-border/50 bg-card/50">
              ...
              <CardContent className="space-y-4">
                <p className="text-base leading-relaxed text-foreground font-body">
                  {faculty.name} is a dedicated faculty member in the Data Science department at Dayananda Sagar University. With expertise in machine learning, data analytics, statistical methods, and data visualization, {faculty.name.split(' ')[0]} contributes significantly to academic excellence and research endeavors.
                </p>
                <p className="text-base leading-relaxed text-foreground font-body">
                  Committed to advancing Data Science education and fostering innovation, {faculty.name.split(' ')[0]} engages in curriculum development, student mentorship, and collaborative projects with academic institutions and industry partners. The faculty brings a blend of theoretical knowledge and practical expertise to enrich the learning experience of students.
                </p>
            ...
            <Card className="border border-border/50 bg-card/50">
              ...
              <CardContent className="text-sm text-foreground font-body">
                <p>
                  Dedicated to advancing Data Science education and research. Engaged in curriculum development, student mentorship, and collaborative projects focusing on machine learning, statistical methods, data analytics, business intelligence, data visualization, and emerging data science technologies.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border border-border/50 bg-card/50">
              ...
              <CardContent className="space-y-3 text-sm font-body">
                ...
                <div>
                  ...
                  <div className="font-medium text-foreground">Data Science</div>
                </div>
              </CardContent>
            </Card>
