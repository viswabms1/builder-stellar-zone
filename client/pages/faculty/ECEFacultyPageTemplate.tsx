...
import type { Faculty } from "@/data/ece-faculty";

interface ECEFacultyPageTemplateProps {
  faculty: Faculty;
}

export default function ECEFacultyPageTemplate({ faculty }: ECEFacultyPageTemplateProps) {
  const bg = "https://images.unsplash.com/photo-1580894908361-967195033215?q=80&w=1600&auto=format&fit=crop";
            ...
            <Card className="rounded-2xl border border-border/50 bg-card/95 backdrop-blur">
              <CardContent className="p-5 md:p-6 flex gap-6 md:gap-8 items-center">
                ...
                <div className="flex-1">
                  <div className="text-brand-blue text-xs font-body">Electronics & Communication Engineering</div>
          ...
          <div className="lg:col-span-2 space-y-8">
            <Card className="border border-border/50 bg-card/50">
              ...
              <CardContent className="space-y-4">
                <p className="text-base leading-relaxed text-foreground font-body">
                  {faculty.name} is a dedicated faculty member in the Electronics & Communication Engineering department at Dayananda Sagar University. With expertise in VLSI design, signal processing, communication systems, and electronics innovation, {faculty.name.split(' ')[0]} contributes significantly to academic excellence and research endeavors.
                </p>
                <p className="text-base leading-relaxed text-foreground font-body">
                  Committed to advancing electronics and communication engineering education and fostering innovation, {faculty.name.split(' ')[0]} engages in curriculum development, student mentorship, and collaborative projects with academic institutions and industry partners. The faculty brings a blend of theoretical knowledge and practical expertise to enrich the learning experience of students.
                </p>
            ...
            <Card className="border border-border/50 bg-card/50">
              ...
              <CardContent className="text-sm text-foreground font-body">
                <p>
                  Dedicated to advancing electronics and communication engineering education and research. Engaged in curriculum development, student mentorship, and collaborative projects with industry and academic institutions focusing on VLSI design, signal processing, communications systems, and emerging technologies.
                </p>
              </CardContent>
            </Card>
          ...
          <div className="space-y-8">
            ...
            <Card className="border border-border/50 bg-card/50">
              ...
              <CardContent className="space-y-2 text-sm font-body">
                ...
                <div className="text-foreground/70">Electronics & Communication Engineering</div>
                <div className="text-foreground/70 text-xs">Dayananda Sagar University</div>
              </CardContent>
            </Card>

            <Link to="/academics/engineering/electronics-communication/faculty" className="block">
