            ...
            <Card className="rounded-2xl border border-border/50 bg-card/95 backdrop-blur">
              <CardContent className="p-5 md:p-6 flex gap-4 md:gap-6 items-center">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-foreground text-sm">Associate Professor</div>
        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-3 gap-8 items-start">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <Card className="border border-border/50 bg-card/50">
              ...
              <CardContent className="grid sm:grid-cols-2 gap-4 text-sm font-body">
                <div>
                  <div className="text-foreground">CSE 635 · Spring 2025</div>
                  <div className="font-medium">Robot Perception & Control</div>
                </div>
                <div>
                  <div className="text-foreground">CSE 420 · Fall 2024</div>
          ...
          <div className="space-y-8">
            <Card className="border border-border/50 bg-card/50">
              ...
              <CardContent className="space-y-3 text-sm font-body">
                <div className="flex items-center gap-2 text-foreground"><MapPin className="w-4 h-4"/> Robotics Lab, Tech Park — 2nd Floor</div>
                <div className="flex items-center gap-2 text-foreground"><Clock className="w-4 h-4"/> Office Hours: Mon, 3:00–5:00 PM</div>
              </CardContent>
            </Card>
