...
import type { Faculty } from "@/data/cybersecurity-faculty";

interface CybersecurityFacultyPageTemplateProps {
  faculty: Faculty;
}

export default function CybersecurityFacultyPageTemplate({ faculty }: CybersecurityFacultyPageTemplateProps) {
  const bg = "https://images.unsplash.com/photo-1550751827-4bd582f200e7?q=80&w=1600&auto=format&fit=crop";
            ...
            <Card className="rounded-2xl border border-border/50 bg-card/95 backdrop-blur">
              <CardContent className="p-5 md:p-3 flex gap-3 md:gap-4 items-center">
                ...
                <div className="flex-1">
                  <div className="text-brand-blue text-xs font-body">Cybersecurity</div>
          ...
          <div className="lg:col-span-2 space-y-4">
            <Card className="border border-border/50 bg-card/50">
              ...
              <CardContent className="space-y-4">
                <p className="text-base leading-relaxed text-foreground font-body">
                  {faculty.name} is a dedicated faculty member in the Cybersecurity department at Dayananda Sagar University. With expertise in network security, cryptography, threat analysis, and incident response, {faculty.name.split(' ')[0]} contributes significantly to academic excellence and research endeavors.
                </p>
                <p className="text-base leading-relaxed text-foreground font-body">
                  Committed to advancing Cybersecurity education and fostering innovation, {faculty.name.split(' ')[0]} engages in curriculum development, student mentorship, and collaborative projects with academic institutions and cybersecurity industry partners. The faculty brings a blend of theoretical knowledge and practical expertise to enrich the learning experience of students.
                </p>
            ...
            <Card className="border border-border/50 bg-card/50">
              ...
              <CardContent className="text-sm text-foreground font-body">
                <p>
                  Dedicated to advancing Cybersecurity education and research. Engaged in curriculum development, student mentorship, and collaborative projects focusing on network security, cryptography, penetration testing, secure programming, threat intelligence, incident response, and emerging cybersecurity technologies.
                </p>
              </CardContent>
            </Card>
