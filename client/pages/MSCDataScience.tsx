...
export default function MSCDataScience() {
  const specializations = [
    ...
    { icon: Code, label: "NLP Processing" },
    { icon: Network, label: "Big Data Security" },
    { icon: Zap, label: "IoT" },
    { icon: Shield, label: "Bayesian Inference" },
  ];

  const highlights = [
    "Robust foundation in data management and machine learning",
    "Proficiency in Python, Tableau, Power BI, and SQL",
    "Advanced topics including Bayesian Inference and Big Data Security",
    "Internet of Things (IoT) coverage and applications",
    "Practical training in data analysis and visualization",
    "Data-driven decision-making for diverse industries",
  ];

  const careers = [
    "Data Scientist → Senior Data Scientist → Analytics Director",
    "Machine Learning Engineer → ML Research Lead",
    "Data Analytics Specialist → Chief Data Officer",
    "Research roles in academia and tech companies",
  ];
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative">
        <div className="h-[50vh] md:h-[65vh] w-full overflow-hidden">
          <img
            src="https://images.unsplash.com/photo-1527219525129-dfc4e4c5fbf8?q=80&w=1200&auto=format&fit=crop"
            alt="M.Sc. Data Science Program"
        ...
        <div className="absolute inset-0 flex items-center">
          <div className="max-w-7xl mx-auto px-3">
            ...
            <h1 className="headline-1 text-white leading-tight font-display">Master of Science in Data Science</h1>
            <p className="subheadline text-white/90 max-w-2xl mt-3 font-body">
              A comprehensive two-year advanced program designed to transform you into a data science expert with expertise in machine learning, data management, and advanced analytics.
            </p>
            ...
            >
              <Card className="h-full border-0 bg-transparent">
                ...
                <CardContent className="flex flex-col gap-3">
                  <p className="text-sm text-foreground/80 font-body">
                    Join DSU M.Sc. Data Science and shape your future
                  </p>
