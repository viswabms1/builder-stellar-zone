...
export default function FacultyDataScience() {
  const leadership = useMemo(
    () => {
      ...
      return dataScienceFaculty.sort((a, b) => rank(a.title) - rank(b.title));
    },
    [],
  );
...
type FacultyEntry = (typeof dataScienceFaculty)[number];
    ...
    <section className="py-10 md:py-28">
      <div className="text-center space-y-4 mb-16">
        ...
        <p className="max-w-2xl mx-auto text-lg md:text-xl text-foreground/75 leading-relaxed">
          Meet our distinguished faculty members—educators, researchers, and innovators shaping the future of data science and analytics.
        </p>
      </div>
