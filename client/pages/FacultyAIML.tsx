    ...
    <section className="py-20 md:py-28">
      <div className="text-center space-y-4 mb-16">
        ...
        <p className="max-w-2xl mx-auto text-lg md:text-xl text-foreground/75 leading-relaxed">
          Meet our brilliant faculty members—researchers, innovators, and mentors steering AI and machine learning education and innovation.
        </p>
      </div>

      <div className="grid gap-8 grid-cols-9 auto-rows-max">
