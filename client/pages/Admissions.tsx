      ...
      <section className="relative py-20 lg:py-32 bg-gradient-to-br from-orange-500/10 via-red-600/5 to-background">
        ...
        <div className="relative max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground mb-12 max-w-4xl mx-auto leading-relaxed">
            Join thousands of students who have chosen DSU for their academic
            journey.
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Follow our streamlined 4-step process to secure your admission at
              DSU
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Complete your application form online with all required documents",
                details: [
              ...
              },
              {
                ...
                title: "Entrance Exam",
                description:
                  "Appear for DSU entrance test or submit valid scores",
                details: [
                  "DSAT (DSU SAT)",
                  "JEE/NEET Scores",
                  "GATE Scores",
              ...
              },
              {
                ...
                title: "Counseling",
                description:
                  "Attend counseling session for course and campus selection",
                details: [
            ...
            {[
              {
                ...
                description:
                  "Based on academic performance in qualifying exams",
                criteria: [
                  "90%+ in 12th grade",
                  "Top 10% in entrance exam",
              ...
              },
              {
                ...
                criteria: [
                  "State/National level player",
                  "Sports certificates",
                  "College team participation",
                ],
              ...
              <Card
                key={index}
                className="group hover:shadow-xl hover:shadow-orange-500/10 transition-all duration-500 hover:-translate-y-2 bg-gradient-to-br from-orange-500/5 to-red-600/5 border border-orange-500/20"
              >
                <CardHeader>
