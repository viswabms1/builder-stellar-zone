      ...
      <div className="relative mx-auto max-w-7xl px-6">
        <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
          <div className="space-y-4 text-center lg:text-left">
            ...
            <p className="max-w-2xl text-base text-slate-900 dark:text-slate-200 md:text-lg">
      ...
      <div className="mx-auto max-w-7xl space-y-6">
        <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-end">
          <div>
            ...
            <p className="text-sm text-slate-900 dark:text-slate-200 sm:text-base">
    ...
    <section className="bg-gradient-to-br from-brand-magenta/5 via-brand-orange/5 to-brand-blue/5 px-6 py-16">
      <div className="mx-auto max-w-7xl space-y-8">
        ...
        <div className="grid gap-6 sm:grid-cols-2 xl:grid-cols-3">
          {filteredFaculty.map((faculty) => (
            ...
            >
              ...
              <CardContent className="flex flex-1 flex-col gap-4 p-5 text-sm text-slate-900 dark:text-slate-200">
                {faculty.qualifications ? (
                  <p>
                    <span className="font-semibold text-foreground">Qualifications:</span> {faculty.qualifications}
                  </p>
        ...
        {filteredFaculty.length === 0 ? (
          <div className="rounded-3xl border border-dashed border-brand-magenta/30 bg-white/60 p-10 text-center text-sm text-slate-900 dark:text-slate-200">
        ...
        <div className="fixed right-0 top-0 bottom-0 w-80 z-50 lg:static lg:z-auto overflow-y-auto bg-background lg:w-full p-6 lg:p-0">
          <div className="space-y-4">
            <div className="hidden lg:block mb-6">
              ...
              <p className="text-sm text-slate-900 dark:text-slate-200">Navigate department resources and information</p>
            </div>
  ...
  return (
    <section className="px-6 pb-20">
      <div className="mx-auto max-w-5xl rounded-3xl border border-brand-magenta/20 bg-gradient-to-r from-brand-magenta/15 via-brand-orange/15 to-brand-blue/15 p-10 text-center shadow-lg">
        ...
        <p className="mt-4 text-lg text-slate-900 dark:text-slate-200">
