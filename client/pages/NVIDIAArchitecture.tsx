...
export default function NVIDIAArchitecture() {
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section id="explore" className="px-3 py-20 bg-gradient-to-r from-brand-blue/5 via-brand-magenta/5 to-brand-blue/5">
      ...
      <section className="px-3 py-20">
        <div className="max-w-7xl mx-auto">
            ...
            <Card className="border-border/50 bg-gradient-to-br from-card/80 via-card/60 to-card/40 backdrop-blur overflow-hidden hover:shadow-lg hover:shadow-brand-blue/20 transition-all duration-300">
              <div className="grid md:grid-cols-2 gap-0">
                <div className="p-8 border-r border-border/30">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-6 font-display">DGX B200</h3>
          ...
          {/* Jetson Family */}
          <div>
            <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-8 font-display">
      ...
      <section className="px-3 py-20 bg-gradient-to-r from-brand-magenta/5 via-brand-magenta/10 to-brand-magenta/5 dark:via-black/50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            <h2 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-4 font-display">
