...
export default function Research() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {[
              ...
              return (
                <Card
                  key={index}
                  className="bg-gradient-to-br from-card/80 via-card/60 to-card/40 backdrop-blur-sm border border-border/50 hover:border-brand-blue/30 transition-all duration-300"
                >
                  <CardHeader>
      ...
      <section
        ref={spotlightsRef}
        className="px-3 py-10 lg:py-16 bg-gradient-to-br from-brand-magenta/5 via-brand-blue/5 to-background dark:from-brand-magenta/5 dark:via-brand-blue/5 dark:to-black"
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-bold font-display mb-6">
