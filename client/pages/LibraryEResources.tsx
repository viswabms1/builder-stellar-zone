...
export default function LibraryEResources() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      {/* Hero Section */}
      <section className="relative py-16 lg:py-24 bg-gradient-to-br from-purple-500/10 via-pink-600/5 to-background dark:from-purple-500/20 dark:via-pink-600/15 overflow-hidden">
