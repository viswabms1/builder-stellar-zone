          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-foreground/80 mb-8 max-w-xl font-display leading-relaxed">
                We're not just teaching traditional courses. We're integrating AI, emerging technologies, and industry partnerships into every program to prepare you differently.
              </p>
