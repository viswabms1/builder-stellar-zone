...
function FacultyGridCard({ faculty }: { faculty: FacultyEntry }) {
  return (
    <div className="group overflow-hidden rounded-xl border border-border/50 bg-card/70 shadow-md transition-all duration-300 hover:-translate-y-1.5 hover:shadow-lg hover:shadow-brand-blue/20">
      <div className="relative overflow-hidden bg-slate-200 dark:bg-slate-800">
        ...
        <div className="absolute bottom-0 w-full p-3 text-white">
          <p className="text-xs font-bold line-clamp-2 group-hover:text-brand-blue transition-colors">
            {faculty.name}
          </p>
      ...
      <div className="text-center space-y-4 mb-16">
        <div>
          <h2 className="text-4xl md:text-5xl font-bold font-display text-foreground mb-3">
            School of Basic & Applied Sciences Faculty
          </h2>
