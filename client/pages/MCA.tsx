...
export default function MCA() {
  ...
  const highlights = [
    ...
    "Curriculum aligned with modern technology landscapes",
    "Latest advancements in IT and software engineering",
    "Hands-on projects and real-world problem exposure",
    "Development of critical thinking and leadership skills",
    "Focus on innovation and organizational impact",
  ];

  const careers = [
    "Software Architect → Enterprise Solutions Lead",
    "Technical Lead → Engineering Manager",
    "Solutions Consultant → IT Strategy Lead",
    "Research roles in academia and tech innovation",
  ];
        ...
        <div className="absolute inset-0 flex items-center">
          <div className="max-w-7xl mx-auto px-3">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-brand-magenta/10 rounded-full border border-brand-magenta/20 mb-4">
              ...
              <span className="text-sm font-medium text-brand-magenta font-display">Master of Computer Applications</span>
            </div>
            <h1 className="headline-1 text-white leading-tight font-display">Master of Computer Applications</h1>
            <p className="subheadline text-white/90 max-w-2xl mt-3 font-body">
              A comprehensive two-year advanced program designed to transform you into an adept professional in computer science and applications with cutting-edge technical expertise.
            </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <Card className="border border-border/50 bg-card/50 backdrop-blur-sm hover:shadow-lg transition-all">
              <CardHeader>
                ...
                <CardTitle className="font-display">Master of Computer Applications</CardTitle>
              ...
              <CardContent className="space-y-3">
                ...
                <div className="flex flex-wrap gap-2">
                  {["Enterprise Systems", "Cybersecurity", "Cloud Architecture", "Advanced Databases", "Distributed Systems", "Emerging Tech"].map((spec, i) => (
            ...
            <Card className="border border-border/50 bg-card/50 backdrop-blur-sm hover:shadow-lg transition-all">
              <CardHeader>
                ...
                <CardDescription className="font-body">What makes MCA unique</CardDescription>
              </CardHeader>
              <CardContent className="space-y-3">
                <p className="text-sm text-foreground font-body">Advanced curriculum with:</p>
                <div className="flex flex-wrap gap-2">
                  {["Advanced Topics", "Industry Focus", "Research", "Innovation", "Leadership"].map((feat, i) => (
        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-3 gap-5 items-start">
          <div className="lg:col-span-2 space-y-3">
            ...
            <div className="space-y-4 text-foreground leading-relaxed font-body">
              <p>
                The MCA program is meticulously crafted to transform students into adept professionals in the realm of computer science and applications. With a curriculum that bridges theoretical knowledge and practical application, the program ensures that graduates are prepared to tackle the complexities of modern technology landscapes.
              </p>
              <p>
                In today's rapidly evolving business world, industries demand innovative solutions and advanced technological skills. The MCA program addresses these demands by immersing students in the latest advancements in IT, enabling them to stay ahead of the curve. Through rigorous coursework, hands-on projects, and exposure to real-world challenges, students gain the expertise needed to thrive in competitive environments.
              </p>
              <p>
                Our program not only focuses on technical proficiency but also fosters critical thinking, problem-solving abilities, and leadership qualities. Graduates emerge as well-rounded professionals capable of driving technological innovations and contributing significantly to their organizations and society at large. The MCA program is your gateway to becoming a leader in the ever-expanding field of computer science and applications.
              </p>
            </div>
            <Card className="border border-border/50 bg-card/50 backdrop-blur-sm">
          ...
          <div>
            <Card className="overflow-hidden border border-border/50 bg-card/50">
              <div className="relative h-40">
                <img src="https://images.unsplash.com/photo-1498050108023-c5249f4df085?q=80&w=600&auto=format&fit=crop" alt="MCA Program" className="w-full h-full object-cover" />
              </div>
              <CardHeader>
      ...
      <section className="px-3 py-8">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-5 items-start">
          ...
          <div>
            ...
            <Card className="overflow-hidden border border-border/50 bg-card/50">
              <div className="relative h-40">
                <img src="https://images.unsplash.com/photo-1557804506-669a67965ba0?q=80&w=1200&auto=format&fit=crop" alt="Contact MCA" className="w-full h-full object-cover" />
              </div>
              <CardHeader>
              ...
              <CardContent className="grid gap-2 text-sm font-body">
                <div className="flex items-center justify-between"><span>Email</span><a className="font-medium hover:underline" href="mailto:info-mca@dsu.edu.in">info-mca@dsu.edu.in</a></div>
            ...
            >
              <Card className="h-full border-0 bg-transparent">
                ...
                <CardContent className="flex flex-col gap-3">
                  <p className="text-sm text-foreground/80 font-body">
                    Join DSU MCA and shape your future
                  </p>
      ...
      <section className="px-3 py-8">
        <div className="max-w-4xl mx-auto text-center">
          <div className="rounded-3xl p-5 border border-brand-magenta/20 bg-brand-magenta/5">
            <h3 className="headline-3 mb-3 font-display">Join DSU MCA</h3>
            <p className="text-foreground mb-6 font-body">Explore programs, discover opportunities, and launch your career as a master of computer applications.</p>
...
function CurriculumLibrary() {
  ...
  const programs: CurriculumProgram[] = [
    {
      id: "mca",
      label: "M.C.A. Curriculum",
      description: "2-year comprehensive postgraduate pathway with industry-aligned curriculum",
      image: "https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=600&h=400&fit=crop",
      batches: [
        {
          year: "2025-26",
          summary: "Latest curriculum with advanced technologies and practical project integration across all 4 semesters",
          documentUrl:
            "https://www.dsu.edu.in/images/ComputerApplications/MCA-Curriculum-2025-26.pdf",
        },
      ],
    },
  ];
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="max-w-2xl text-sm text-foreground sm:text-base font-body">
              Access comprehensive curriculum documentation, course structures, learning outcomes, and downloadable syllabus for the MCA program.
            </p>
          </div>
