            ...
            return (
              <div key={item.label} className="space-y-3">
                <div className="flex items-center gap-2">
                  <ContentTag
                    {...(item.href
                      ...
                      : { type: "button" })}
                    className="flex flex-1 items-center gap-3 rounded-2xl border border-transparent px-3 py-2 text-left text-foreground/75 transition hover:border-white/10 hover:bg-white/5 hover:text-foreground"
                  >
                    <item.icon className="h-4 w-4 text-foreground/60" aria-hidden="true" />
                  ...
                  {item.children && (
                    <button
                      ...
                      className="flex h-8 w-8 items-center justify-center rounded-full border border-white/10 bg-white/5 text-foreground/60 transition hover:text-foreground"
                    >
                      <ChevronDown
                ...
                {item.children && isExpanded && (
                  <ul className="space-y-2 pl-9 text-xs text-foreground/60">
                    {item.children.map((child) => (
                      <li key={child.href}>
                        <a
                          href={child.href}
                          className="inline-flex items-center gap-2 rounded-full border border-transparent px-3 py-1 transition hover:border-white/10 hover:bg-white/5 hover:text-foreground"
                        >
...
function HeroSection() {
  return (
    <section
      id="home"
      className="scroll-mt-32 rounded-3xl border border-white/10 bg-slate-950/80 text-foreground shadow-[0_40px_140px_-80px_rgba(255,255,255,0.7)]"
    >
        ...
        <div className="relative flex flex-col gap-3 px-4 py-10 lg:flex-row lg:items-center lg:px-12">
          <div className="flex-1 space-y-3">
            ...
            <div className="flex flex-wrap items-center gap-4">
              <Button
                asChild
                className="bg-brand-gradient text-foreground shadow-lg shadow-brand-magenta/20 hover:opacity-90"
              >
        ...
        {STAT_CARDS.map((card) => (
          ...
          >
            ...
            <div className="relative space-y-4">
              ...
              <p className="text-sm text-foreground/75 font-body">{card.description}</p>
            </div>
          </div>
        ))}
      </div>
  ...
  return (
    <section id="about" className="scroll-mt-32 space-y-10">
      <header className="space-y-4 text-foreground">
        ...
        <p className="max-w-3xl text-base text-foreground/75 font-body">
      ...
      <div className="grid gap-3 lg:grid-cols-2">
        {ABOUT_SECTIONS.map((section) => (
          ...
          >
            ...
            <ul className="mt-4 space-y-3 text-sm text-foreground/80 font-body">
    ...
    <section id="idp" className="scroll-mt-32 space-y-3 rounded-3xl border border-white/10 bg-white/5 p-4 text-foreground">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div className="max-w-3xl space-y-3">
          ...
          <h2 className="text-2xl font-semibold text-foreground">Roadmap for future-ready academic excellence</h2>
      ...
      <ul className="grid gap-4 text-sm text-foreground/80 font-body lg:grid-cols-2">
...
function InstitutionalExcellenceSection() {
  return (
    <section id="institutional-excellence" className="scroll-mt-32 space-y-12 text-foreground">
        ...
        <div className="grid gap-4 text-sm text-foreground/80 font-body lg:grid-cols-3">
          {MOU_LIST.map((mou) => (
            ...
            >
              ...
              <h4 className="mt-3 text-lg font-semibold text-foreground">{mou.partner}</h4>
...
function ReportsSection() {
  return (
    <section id="reports" className="scroll-mt-32 space-y-10 text-foreground">
      <header className="space-y-4">
        <span className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/10 px-3 py-1 text-xs font-semibold uppercase tracking-[0.28em] text-foreground/70">
  ...
  return (
    <section id="policies" className="scroll-mt-32 space-y-4 rounded-3xl border border-white/10 bg-white/5 p-4 text-foreground">
      <header className="space-y-3">
        ...
        <h2 className="text-2xl font-semibold text-foreground">Frameworks that anchor quality systems</h2>
        <p className="text-sm text-foreground/75 font-body">
  ...
  return (
    <section id="committees" className="scroll-mt-32 space-y-3 text-foreground">
      <header className="space-y-3">
        ...
        <h2 className="text-2xl font-semibold text-foreground">Quality governance through specialised committees</h2>
        <p className="text-sm text-foreground/75 font-body">
          ...
          >
            ...
            <p className="mt-4 text-foreground/60">
              ...
              <a
                ...
                className="font-medium text-foreground transition hover:text-brand-magenta"
              >
                {committee.contact}
              </a>
            </p>
  ...
  return (
    <section id="forms" className="scroll-mt-32 space-y-3 rounded-3xl border border-white/10 bg-white/5 p-4 text-foreground">
      <header className="space-y-3">
        ...
        <h2 className="text-2xl font-semibold text-foreground">Templates for consistent documentation</h2>
        <p className="text-sm text-foreground/75 font-body">
      ...
      <div className="space-y-4">
        {FORM_TEMPLATES.map((form) => (
          ...
          >
            ...
            <a
              href={form.access}
              className="mt-3 inline-flex items-center gap-2 text-sm font-semibold text-foreground/80 transition hover:text-foreground"
            >
  ...
  return (
    <section id="value-added" className="scroll-mt-32 space-y-3 text-foreground">
      <header className="space-y-3">
        ...
        <h2 className="text-2xl font-semibold text-foreground">Future-oriented certifications curated by IQAC</h2>
        <p className="text-sm text-foreground/75 font-body">
      ...
      <div className="grid gap-3 lg:grid-cols-3">
        {VALUE_ADDED_OFFERINGS.map((course) => (
          ...
          >
            ...
            <p className="mt-3 text-foreground/60">{course.duration}</p>
  ...
  return (
    <section id="event-calendar" className="scroll-mt-32 space-y-3 rounded-3xl border border-white/10 bg-white/5 p-4 text-foreground">
      <header className="space-y-3">
        ...
        <h2 className="text-2xl font-semibold text-foreground">Upcoming IQAC-led programmes</h2>
        <p className="text-sm text-foreground/75 font-body">
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        {EVENT_SCHEDULE.map((event) => (
          ...
          >
            ...
            <p className="mt-2 text-foreground/60">{event.category}</p>
  ...
  return (
    <section id="feedback" className="scroll-mt-32 space-y-3 rounded-3xl border border-white/10 bg-white/5 p-4 text-foreground">
      <header className="space-y-3">
        ...
        <h2 className="text-2xl font-semibold text-foreground">Partner with the IQAC office</h2>
        <p className="text-sm text-foreground/75 font-body">
      ...
      <div className="grid gap-3 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)]">
        ...
        <div className="space-y-4 rounded-3xl border border-white/10 bg-slate-950/60 p-3 text-sm text-foreground/80 font-body">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="font-semibold text-foreground">Submit feedback</p>
              <p className="mt-1">Share commendations, suggestions, or concerns to inform IQAC action plans.</p>
              <Button
                asChild
                variant="secondary"
                className="mt-4 bg-white/10 text-foreground hover:bg-white/20"
              >
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="font-semibold text-foreground">Request facilitation</p>
              ...
              <p className="mt-3 text-foreground/70">
                Email <a href="mailto:iqac@dsu.edu.in?subject=IQAC%20Facilitation%20Request" className="font-medium text-foreground transition hover:text-brand-magenta">iqac@dsu.edu.in</a> with the proposed agenda and timelines.
              </p>
            </div>
          </div>
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="font-semibold text-foreground">Document access</p>
