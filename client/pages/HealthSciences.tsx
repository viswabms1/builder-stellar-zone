...
function HeroVideo() {
  ...
  return (
    <div className="h-dvh md:h-[75vh] relative overflow-hidden flex items-end md:items-center justify-start hero-video-container" style={{ width: '100vw', marginLeft: 'calc(-50vw + 50%)', WebkitApperance: 'none' }} ref={containerRef}>
      <video
        ref={videoRef}
