...
const ALL_EVENTS: Event[] = [
  ...
  {
    id: "event-commerce-bba-1",
    title: "Startup Pitch Competition",
    description: "Present your business ideas to industry experts and venture capitalists. Prizes worth ₹5 Lakhs.",
    date: "Feb 24, 2025",
    time: "10:00 AM",
  ...
  {
    id: "event-commerce-bcom-1",
    title: "Financial Accounting Workshop",
    description: "Hands-on session on advanced accounting software and financial statement preparation.",
    date: "Feb 26, 2025",
    time: "2:00 PM",
    location: "Commerce Department Computer Lab",
    status: "upcoming",
    school: "Commerce & Management",
    department: "BCom",
    category: "Workshop",
  ...
  {
    id: "event-commerce-mba-1",
    title: "Leadership Summit 2025",
    description: "CEOs and industry leaders share insights on strategic leadership and business transformation.",
    date: "Feb 28, 2025",
    time: "9:00 AM",
    location: "MBA Executive Learning Center",
    status: "upcoming",
    school: "Commerce & Management",
    department: "MBA",
    category: "Seminar",
