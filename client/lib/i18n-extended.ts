...
export const indexTranslations = {
  ...
  kn: {
    programs: {
      ...
      law: {
        title: "ಕಾನೂನು ಶಾಲೆ",
        description: "ಆದರ್ಶ ಕಾನೂನು, ಅಭ್��ಾಸ, ಮಾಕ್ ನ್ಯಾಯಾಲಯಗಳು, ಪರಿಶೋಧನೆ ಮತ್ತು ಸಂಶೋಧನಾ ಅವಕಾಶಗಳನ್ನು ಮಿಶ್ರ ವ್ಯಾಪಕ ಕಾನೂನು ಶಿಕ್ಷೆ.",
        programs: ["BA LLB", "BBA LLB", "LLB", "LLM"],
      },
      management: {
        title: "ವಿಷಯಾಧಿಕಾರ ಮತ್ತು ನಿರ್ವಹಣೆ ಅಧ್ಯಯನ",
        description: "ಮುಖ್ಯ ನಿರ್ವಹಣೆಯನ್ನು ವಿಶ್ಲೇಷಣ, ಉದ್ಯೋಗಿತೆ ಮತ್ತು ಶಿಲ್ಪ ಯೋಜನೆಗಳೊಂದಿಗೆ ವ್ಯವಹಾರ ಶಿಕ್ಷೆ.",
        programs: ["B.Com", "BBA", "MBA", "ವಿತ್ತ ಮತ್ತು ಮಾರ್ಕೆಟಿಂಗ್"],
      },
      sciences: {
        title: "ಮೂಲಭೂತ ಮತ್ತು ಪ್ರಯುಕ್ತ ವಿಜ್ಞಾನ",
        description: "ಬಲವಾದ ಲ್ಯಾಬ್ ಪ್ರದರ್ಶನ ಮತ್ತು ಸಂಶೋಧನಾ-ಚಾಲಿತ ಕಲಿಕೆಯೊಂದಿಗೆ ಮೂಲಭೂತ ಮತ್ತು ಅಂತರ್ವಿಷಯೀಯ ವಿಜ್ಞಾನ.",
  ...
  hi: {
    programs: {
      ...
      computerApplications: {
        ...
        description: "प्रोग्रामिंग, डेटा, क्लाउड और आधुन��क एप्लिकेशन विकास में मजबूत नींव के साथ सॉफ्टवेयर कैरियर बनाएं।",
      ...
      design: {
        ...
        description: "UX/UI, ग्राफिक्स, एनिमेशन और आधुनिक प्लेटफार्मों के लिए कहानी कहने में डिजाइन और डिजिटल मीडिया प्रोग��राम।",
