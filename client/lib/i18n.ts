  ...
  kn: {
    ...
    academics: {
      ...
      computerApplications: {
        ...
        description: 'ಪ್ರೋಗ್ರಾಮಿಂಗ್, ಡೇಟಾ, ಕ್ಲೌಡ್ ಮತ್ತು ಆಧುನಿಕ ಅನ್ವಯ ಅಭಿವೃದ್ಧಿಯಲ್ಲಿ ಬಲವಾದ ಆಧಾರಗಳೊಂದಿಗೆ ತಂತ್ರಜ್ಞ ಕ್ಷೇತ್ರ ನಿರ್ಮಾಣ.',
      ...
      design: {
        title: 'ಡಿজಾಇನ್ ಮತ್ತು ಡಿಜಿಟಲ್ ಟ್ರಾನ್ಸ್ ಮಿಡ��ಯಾ',
    ...
    campusLife: {
      ...
      subheadline: 'ಸ್ನೇ��ಮಯ ಬೆಳೆದ ತಜ್ಞತೆ ಶೋಧಿಸಲಾಗುತ್ತದೆ ಮತ್ತು ಸ್ಮೃತಿಗಳ ನಿರ್ಮಾಣ ಮಾಡಲಾಗುತ್ತದೆ ಏಕ ಕ್ಯಾಂಪಸ್ ಸಮುದಾಯದ ಅನುಭವವನ್ನು ನಿರ್ಮಾಣ ಮಾಡಿ.',
    ...
    historyPage: {
      ...
      legacy: 'ದಯಾನಂ��� ಸಾಗರ ಸಂಸ್ಥೆ ಪರಂಪರೆ',
    },
    placementsPage: {
      title: 'ನೇಮಕಾತಿ',
  ...
  hi: {
    ...
    academics: {
      ...
      computerApplications: {
        ...
        description: 'प्रोग्रामिंग, डेटा, क्लाउड और आधुनिक एप्लिकेशन विकास में ��जबूत नींव के साथ सॉफ्टवेयर कैरियर बनाएं।',
      ...
      sciences: {
        ...
        programs: ['भौतिकी', 'रसायन विज्ञान', 'गणित', 'जैव प्रौ��्योगिकी'],
      },
      health: {
      ...
      medical: {
        ...
        description: 'नवीनता और सामुदायिक प्रभाव ���र ध्यान केंद्रित करके उन्नत चिकित्सा शिक्षा और अनुवादकारी अनुसंधान।',
