...
export const translations = {
  en: {
    ...
    campusLife: {
      ...
      subheadline: 'Experience a vibrant campus community where friendships are made, talents are discovered, and memories are created.',
    ...
    journalismPage: {
      ...
      academicPathwaysDesc: 'Comprehensive programme combining rigorous academics with multimedia storytelling, broadcast production, global collaborations and real-world reporting experience to prepare industry-ready communicators.',
      undergraduateProgram: 'Undergraduate Program',
      bachelorDegree: 'Bachelor Degree Program',
      bachelorDegreeDesc: 'Master multimedia storytelling across print, television, digital media and film',
      baJmc: 'BA (Journalism & Mass Communication)',
      baJmcArea: 'Undergraduate',
      baJmcDesc: 'Three-year programme covering print, television, digital media, filmmaking, podcasting, advertising, public relations and theatre with compulsory two-month internship.',
      ...
      exploreMoreDesc: 'Discover our creative studios, industry partnerships, placements and admission pathways',
      facultyDirectory: 'Faculty Directory',
      facultyDirectoryDesc: 'Meet our distinguished faculty and academic leadership',
      ...
      researchInnovationDesc: 'Faculty-led media research and storytelling projects',
      placements: 'Placements',
      placementsDesc: 'Career pathways with media organizations and production houses',
      admissionsBtn: 'Admissions',
      admissionsDesc: 'Join DSU CJMC and tell stories that matter',
      noticeBoard: 'Notice Board',
      noticeBoardDesc: 'Stay updated with upcoming events, news, and important announcements from the school.',
      events: 'Events',
      news: 'News',
  ...
  kn: {
    ...
    hero: {
      ...
      subheadline: 'ದಯಾನಂದ ಸಾಗರ ವಿಶ್ವವಿದ್ಯಾಲಯದಲ್ಲಿ ವಿಶ್ವ-ಮಾನದ ಶಿಕ್ಷೆಯನ್ನು ಅನುಭವ ಮಾಡಿ. ನಮ್ಮ ಅತಿಆಧುನಿಕ ಸಸ್ಯಾವಳಿಯಲ್ಲಿ ನವೀನತೆ ಪರಂಪರೆಯೊಂದಿಗೆ ಸಾಕ್ಷಿ ನಿಲ್ಲುವುತ್ತದೆ.',
    ...
    recognition: {
      ...
      subtitle: 'ಪ್ರಮುಖ ರಾಷ್ಟ್ರೀಯ ಮತ್ತು ಅಂತರರಾಷ್ಟ್ರೀಯ ಸಂಸ್ಥೆಗಳಿಂದ ಮಾನ್ಯತೆ ಪಡೆದಿದೆ',
    },
    academics: {
  ...
  hi: {
    ...
    recognition: {
      ...
      subtitle: 'अग्रणी राष्ट्रीय और अंतर्राष्ट्रीय निकायों द्वारा मान्यता प्राप्त',
    },
    academics: {
