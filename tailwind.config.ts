...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        "brand-gradient":
          "linear-gradient(135deg, hsl(var(--brand-magenta)), hsl(var(--brand-orange)))",
        "brand-gradient-alt":
          "linear-gradient(135deg, hsl(var(--brand-blue)), hsl(var(--brand-magenta)))",
        "brand-gradient-warm":
          "linear-gradient(45deg, hsl(var(--brand-orange)), hsl(var(--brand-yellow)))",
      },
    },
  },
